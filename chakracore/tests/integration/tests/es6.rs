...
fn es6to_length_js_jsbuiltin(#[case] variant: Variant) {
    let test = common::Test {
        directory: DIRECTORY,
        source_path: "es6toLength.js",
        compile_flags: vec!["-es6toLength", "-JsBuiltIn-"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn to_primitive_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-es6regexsymbols"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn function_name_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-ES6Generators", "-es6functionnamefull"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn map_functionality_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-ES6ObjectLiterals"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn es6super_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-nonative", "-off:dynamicprofile"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn es6string_apis_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-ES6String", "-ES6RegExSymbols"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn es6symbol_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-CollectGarbage", "-ES6ObjectLiterals", "-ES6RegExSymbols"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn objlit_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-ES6", "-ES6ObjectLiterals"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn es6species_bugs_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-CollectGarbage", "-ES6"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn rest_js(#[case] variant: Variant) {
    let test = common::Test {
        directory: DIRECTORY,
        source_path: "rest.js",
        compile_flags: vec!["-ES6Rest", "-ES6ObjectLiterals", "-ES6Spread"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn regex_case_folding_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-version:6", "-ES6RegExSticky"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn regex_octoquad_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-RegexOptimize"],
        host_args: vec!["summary"],
        tags: HashSet::from(["exclude_test"]),
        ..Default::default()
    };
...
fn regex_code_point_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-ES6RegExSticky"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn regex_prototype_properties_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-ES6RegExPrototypeProperties", "-ES6PrototypeChain"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn regex_symbols_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-ES6RegExSymbols", "-ES6RegExPrototypeProperties"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn expo_js(#[case] variant: Variant) {
    let test = common::Test {
        directory: DIRECTORY,
        source_path: "expo.js",
        compile_flags: vec!["-es7exponentiationoperator"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn os_5403724_js(#[case] variant: Variant) {
    let test = common::Test {
        ...
        compile_flags: vec!["-maxinterpretcount:3", "-off:simpleJit", "-ES6"],
        host_args: vec!["summary"],
        tags: HashSet::from(["exclude_dynapogo"]),
        ..Default::default()
    };
...
fn defer_parse_lambda_js_defer_parse(#[case] variant: Variant) {
    let test = common::Test {
        directory: DIRECTORY,
        source_path: "DeferParseLambda.js",
        compile_flags: vec!["-off:deferparse", "-deferparse"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
...
fn defer_parse_lambda_js_force_undo_defer(#[case] variant: Variant) {
    let test = common::Test {
        directory: DIRECTORY,
        source_path: "DeferParseLambda.js",
        compile_flags: vec!["-off:deferparse", "-deferparse", "-forceundodefer"],
        host_args: vec!["summary"],
        ..Default::default()
    };
    common::run_test_variant(test, variant, common::DEFAULT_TAGS);
