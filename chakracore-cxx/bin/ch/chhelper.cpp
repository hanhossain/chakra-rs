    ...
    else
    {
        ...
        if (bufferValue != nullptr)
        {
            ...
            else // fileContents != nullptr
            {
                ...
                runScript =
                    ChakraRTInterface::JsRunSerialized(bufferValue, DummyJsSerializedScriptLoadUtf8Source,
                    ...
                    JsRuntimeAttributes &jsrtAttributes)
{
    ...
    else
    {
        ...
        {
            jsrtAttributes =
                static_cast<JsRuntimeAttributes>(jsrtAttributes | JsRuntimeAttributeSerializeLibraryByteCode);
        }
        ...
        else
        {
            IfFailGo(RunScript(fileName.c_str(), fileContents, lengthBytes, WScriptJsrt::FinalizeFree, nullptr,
                               fullPath, nullptr, doTTRecord, doTTReplay, chRuntime, ttUri, startEventCount));
        }
    }
Error:
