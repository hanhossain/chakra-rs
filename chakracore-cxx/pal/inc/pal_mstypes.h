...
#define MAKEWORD(a, b)                                                                                                 \
    ((uint16_t)(((uint8_t)((unsigned long)(a) & 0xff)) | ((uint16_t)((uint8_t)((unsigned long)(b) & 0xff))) << 8))
#define MAKELONG(a, b)                                                                                                 \
    ((int32_t)(((uint16_t)((unsigned long)(a) & 0xffff)) | ((uint32_t)((uint16_t)((unsigned long)(b) & 0xffff))) << 16))
#define LOBYTE(w) ((uint8_t)((unsigned long)(w) & 0xff))
#define HIBYTE(w) ((uint8_t)((unsigned long)(w) >> 8))

typedef void *HANDLE;
typedef HANDLE HWND;
typedef struct __PAL_RemoteHandle__
{
    HANDLE h;
} *RHANDLE;
