...
#define _In_                                                                                                           \
    _SAL2_Source_(_In_, (),                                                                                            \
                  _Pre1_impl_(__notnull_impl_notref) _Pre_valid_impl_ _Deref_pre1_impl_(__readaccess_impl_notref))
...
#define _In_reads_to_ptr_opt_z_(ptr)                                                                                   \
    _SAL2_Source_(_In_reads_to_ptr_opt_z_, (ptr), _Pre_opt_ptrdiff_count_(ptr) _Deref_pre_readonly_ _Pre_opt_z_)
...
#define _Out_writes_bytes_all_opt_(size)                                                                               \
    _SAL2_Source_(_Out_writes_bytes_all_opt_, (size), _Out_writes_bytes_to_opt_(_Old_(size), _Old_(size)))
...
#define _Out_writes_to_ptr_opt_z_(ptr)                                                                                 \
    _SAL2_Source_(_Out_writes_to_ptr_opt_z_, (ptr), _Pre_opt_ptrdiff_cap_(ptr) _Post_valid_impl_ Post_z_)
...
#define _Inout_updates_opt_(size)                                                                                      \
    _SAL2_Source_(_Inout_updates_opt_, (size), _Pre_opt_cap_(size) _Pre_valid_impl_ _Post_valid_impl_)
...
#define _Inout_updates_to_opt_(size, count)                                                                            \
    _SAL2_Source_(_Inout_updates_to_opt_, (size, count),                                                               \
                  _Out_writes_to_opt_(size, count) _Pre_valid_impl_ _Pre1_impl_(__count_impl(count)))
...
#define _Inout_updates_bytes_(size)                                                                                    \
    _SAL2_Source_(_Inout_updates_bytes_, (size), _Pre_bytecap_(size) _Pre_valid_impl_ _Post_valid_impl_)
#define _Inout_updates_bytes_opt_(size)                                                                                \
    _SAL2_Source_(_Inout_updates_bytes_opt_, (size), _Pre_opt_bytecap_(size) _Pre_valid_impl_ _Post_valid_impl_)

#define _Inout_updates_bytes_to_(size, count)                                                                          \
    _SAL2_Source_(_Inout_updates_bytes_to_, (size, count),                                                             \
                  _Out_writes_bytes_to_(size, count) _Pre_valid_impl_ _Pre1_impl_(__bytecount_impl(count)))
#define _Inout_updates_bytes_to_opt_(size, count)                                                                      \
    _SAL2_Source_(_Inout_updates_bytes_to_opt_, (size, count),                                                         \
                  _Out_writes_bytes_to_opt_(size, count) _Pre_valid_impl_ _Pre1_impl_(__bytecount_impl(count)))

#define _Inout_updates_bytes_all_(size)                                                                                \
    _SAL2_Source_(_Inout_updates_bytes_all_, (size), _Inout_updates_bytes_to_(_Old_(size), _Old_(size)))
#define _Inout_updates_bytes_all_opt_(size)                                                                            \
    _SAL2_Source_(_Inout_updates_bytes_all_opt_, (size), _Inout_updates_bytes_to_opt_(_Old_(size), _Old_(size)))
...
#define _Outptr_opt_                                                                                                   \
    _SAL2_Source_(_Outptr_opt_, (), _Out_opt_impl_ _Deref_post2_impl_(__notnull_impl_notref, __count_impl(1)))
...
#define _Outptr_opt_result_nullonfailure_                                                                              \
    _SAL2_Source_(_Outptr_opt_result_nullonfailure_, (), _Outptr_opt_ _On_failure_(_Deref_post_null_))
...
#define _COM_Outptr_opt_result_maybenull_                                                                              \
    _SAL2_Source_(_COM_Outptr_opt_result_maybenull_, (), _Outptr_opt_result_maybenull_ _On_failure_(_Deref_post_null_))
...
#define _Outptr_opt_result_bytebuffer_all_(size)                                                                       \
    _SAL2_Source_(_Outptr_opt_result_bytebuffer_all_, (size),                                                          \
...
#define _Outptr_opt_result_bytebuffer_maybenull_(size)                                                                 \
    _SAL2_Source_(_Outptr_opt_result_bytebuffer_maybenull_, (size),                                                    \
...
#define _Outptr_opt_result_bytebuffer_all_maybenull_(size)                                                             \
    _SAL2_Source_(_Outptr_opt_result_bytebuffer_all_maybenull_, (size),                                                \
...
#define _Outref_result_maybenull_                                                                                      \
    _SAL2_Source_(_Outref_result_maybenull_, (),                                                                       \
                  _Pre2_impl_(__notnull_impl_notref, __cap_c_one_notref_impl) _Post_maybenull_ _Post_valid_impl_)
...
#define _Outref_result_bytebuffer_all_(size)                                                                           \
    _SAL2_Source_(_Outref_result_bytebuffer_all_, (size), _Outref_result_bytebuffer_to_(size, _Old_(size)))

#define _Outref_result_buffer_maybenull_(size)                                                                         \
    _SAL2_Source_(_Outref_result_buffer_maybenull_, (size), _Outref_result_maybenull_ _Post1_impl_(__cap_impl(size)))
...
#define _Outref_result_bytebuffer_to_maybenull_(size, count)                                                           \
    _SAL2_Source_(_Outref_result_bytebuffer_to_maybenull_, (size, count),                                              \
                  _Outref_result_bytebuffer_maybenull_(size) _Post1_impl_(__bytecount_impl(count)))
#define _Outref_result_buffer_all_maybenull_(size)                                                                     \
    _SAL2_Source_(_Outref_result_buffer_all_maybenull_, (size), _Outref_result_buffer_to_maybenull_(size, _Old_(size)))
...
#define _Result_zeroonfailure_                                                                                         \
    _SAL2_Source_(_Result_zeroonfailure_, (), _On_failure_(_Notref_impl_ _Deref_impl_ _Out_range_(==, 0)))
...
#define _Ret_maybenull_z_                                                                                              \
    _SAL2_Source_(_Ret_maybenull_z_, (), _Ret2_impl_(__maybenull_impl, __zterm_impl) _Ret_valid_impl_)
...
#define _Ret_writes_(size)                                                                                             \
    _SAL2_Source_(_Ret_writes_, (size), _Ret2_impl_(__notnull_impl, __count_impl(size)) _Ret_valid_impl_)
...
#define _Ret_writes_bytes_(size)                                                                                       \
    _SAL2_Source_(_Ret_writes_bytes_, (size), _Ret2_impl_(__notnull_impl, __bytecount_impl(size)) _Ret_valid_impl_)
#define _Ret_writes_maybenull_(size)                                                                                   \
    _SAL2_Source_(_Ret_writes_maybenull_, (size), _Ret2_impl_(__maybenull_impl, __count_impl(size)) _Ret_valid_impl_)
#define _Ret_writes_maybenull_z_(size)                                                                                 \
    _SAL2_Source_(_Ret_writes_maybenull_z_, (size),                                                                    \
                  _Ret3_impl_(__maybenull_impl, __count_impl(size), __zterm_impl) _Ret_valid_impl_)
...
#define _Ret_writes_to_(size, count)                                                                                   \
    _SAL2_Source_(_Ret_writes_to_, (size, count),                                                                      \
                  _Ret3_impl_(__notnull_impl, __cap_impl(size), __count_impl(count)) _Ret_valid_impl_)
#define _Ret_writes_bytes_to_(size, count)                                                                             \
    _SAL2_Source_(_Ret_writes_bytes_to_, (size, count),                                                                \
                  _Ret3_impl_(__notnull_impl, __bytecap_impl(size), __bytecount_impl(count)) _Ret_valid_impl_)
#define _Ret_writes_to_maybenull_(size, count)                                                                         \
    _SAL2_Source_(_Ret_writes_to_maybenull_, (size, count),                                                            \
                  _Ret3_impl_(__maybenull_impl, __cap_impl(size), __count_impl(count)) _Ret_valid_impl_)
...
#define _Pre_readable_byte_size_(size)                                                                                 \
    _SAL2_Source_(_Pre_readable_byte_size_, (size), _Pre1_impl_(__bytecount_impl(size)) _Pre_valid_impl_)
...
#define _Post_readable_byte_size_(size)                                                                                \
    _SAL2_Source_(_Post_readable_byte_size_, (size), _Post1_impl_(__bytecount_impl(size)) _Post_valid_impl_)
...
// valid size unknown or indicated by type (e.g.:char*)
...
#define _In_opt_z_count_(size)                                                                                         \
    _SAL1_1_Source_(_In_opt_z_count_, (size), _Pre_opt_z_ _Pre_opt_count_(size) _Deref_pre_readonly_)
...
#define _In_opt_z_bytecount_(size)                                                                                     \
    _SAL1_1_Source_(_In_opt_z_bytecount_, (size), _Pre_opt_z_ _Pre_opt_bytecount_(size) _Deref_pre_readonly_)
...
#define _In_opt_z_count_c_(size)                                                                                       \
    _SAL1_1_Source_(_In_opt_z_count_c_, (size), _Pre_opt_z_ _Pre_opt_count_c_(size) _Deref_pre_readonly_)
#define _In_z_bytecount_c_(size)                                                                                       \
    _SAL1_1_Source_(_In_z_bytecount_c_, (size), _Pre_z_ _Pre_bytecount_c_(size) _Deref_pre_readonly_)
#define _In_opt_z_bytecount_c_(size)                                                                                   \
    _SAL1_1_Source_(_In_opt_z_bytecount_c_, (size), _Pre_opt_z_ _Pre_opt_bytecount_c_(size) _Deref_pre_readonly_)
...
#define _In_opt_ptrdiff_count_(size)                                                                                   \
    _SAL1_1_Source_(_In_opt_ptrdiff_count_, (size), _Pre_opt_ptrdiff_count_(size) _Deref_pre_readonly_)
...
#define _Out_opt_z_bytecap_c_(size)                                                                                    \
    _SAL1_1_Source_(_Out_opt_z_bytecap_c_, (size), _Pre_opt_bytecap_c_(size) _Post_valid_impl_ _Post_z_)
...
#define _Out_opt_z_bytecap_x_(size)                                                                                    \
    _SAL1_1_Source_(_Out_opt_z_bytecap_x_, (size), _Pre_opt_bytecap_x_(size) _Post_valid_impl_ _Post_z_)
...
#define _Out_capcount_(capcount)                                                                                       \
    _SAL1_1_Source_(_Out_capcount_, (capcount), _Pre_cap_(capcount) _Post_valid_impl_ _Post_count_(capcount))
#define _Out_opt_capcount_(capcount)                                                                                   \
    _SAL1_1_Source_(_Out_opt_capcount_, (capcount), _Pre_opt_cap_(capcount) _Post_valid_impl_ _Post_count_(capcount))
...
#define _Out_capcount_x_(capcount)                                                                                     \
    _SAL1_1_Source_(_Out_capcount_x_, (capcount), _Pre_cap_x_(capcount) _Post_valid_impl_ _Post_count_x_(capcount))
...
#define _Out_z_capcount_(capcount)                                                                                     \
    _SAL1_1_Source_(_Out_z_capcount_, (capcount), _Pre_cap_(capcount) _Post_valid_impl_ _Post_z_count_(capcount))
...
#define _Deref_pre_z_                                                                                                  \
    _SAL1_1_Source_(_Deref_pre_z_, (),                                                                                 \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__zterm_impl) _Pre_valid_impl_)
#define _Deref_pre_opt_z_                                                                                              \
    _SAL1_1_Source_(_Deref_pre_opt_z_, (),                                                                             \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__zterm_impl) _Pre_valid_impl_)
...
#define _Deref_pre_bytecap_(size)                                                                                      \
    _SAL1_1_Source_(_Deref_pre_bytecap_, (size),                                                                       \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecap_impl(size)))
#define _Deref_pre_opt_bytecap_(size)                                                                                  \
    _SAL1_1_Source_(_Deref_pre_opt_bytecap_, (size),                                                                   \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecap_impl(size)))
...
#define _Deref_pre_opt_cap_c_(size)                                                                                    \
    _SAL1_1_Source_(_Deref_pre_opt_cap_c_, (size),                                                                     \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__cap_c_impl(size)))
#define _Deref_pre_bytecap_c_(size)                                                                                    \
    _SAL1_1_Source_(_Deref_pre_bytecap_c_, (size),                                                                     \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecap_c_impl(size)))
#define _Deref_pre_opt_bytecap_c_(size)                                                                                \
    _SAL1_1_Source_(_Deref_pre_opt_bytecap_c_, (size),                                                                 \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecap_c_impl(size)))
...
#define _Deref_pre_opt_cap_x_(size)                                                                                    \
    _SAL1_1_Source_(_Deref_pre_opt_cap_x_, (size),                                                                     \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__cap_x_impl(size)))
...
#define _Deref_pre_valid_cap_(size)                                                                                    \
    _SAL1_1_Source_(_Deref_pre_valid_cap_, (size),                                                                     \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__cap_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_valid_cap_(size)                                                                                \
    _SAL1_1_Source_(_Deref_pre_opt_valid_cap_, (size),                                                                 \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__cap_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_valid_bytecap_(size)                                                                                \
    _SAL1_1_Source_(_Deref_pre_valid_bytecap_, (size),                                                                 \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecap_impl(size)) _Pre_valid_impl_)
...
#define _Deref_pre_valid_cap_c_(size)                                                                                  \
    _SAL1_1_Source_(_Deref_pre_valid_cap_c_, (size),                                                                   \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__cap_c_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_valid_cap_c_(size)                                                                              \
    _SAL1_1_Source_(_Deref_pre_opt_valid_cap_c_, (size),                                                               \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__cap_c_impl(size)) _Pre_valid_impl_)
...
#define _Deref_pre_valid_cap_x_(size)                                                                                  \
    _SAL1_1_Source_(_Deref_pre_valid_cap_x_, (size),                                                                   \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__cap_x_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_valid_cap_x_(size)                                                                              \
    _SAL1_1_Source_(_Deref_pre_opt_valid_cap_x_, (size),                                                               \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__cap_x_impl(size)) _Pre_valid_impl_)
...
#define _Deref_pre_count_(size)                                                                                        \
    _SAL1_1_Source_(_Deref_pre_count_, (size),                                                                         \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__count_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_count_(size)                                                                                    \
    _SAL1_1_Source_(_Deref_pre_opt_count_, (size),                                                                     \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__count_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_bytecount_(size)                                                                                    \
    _SAL1_1_Source_(_Deref_pre_bytecount_, (size),                                                                     \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecount_impl(size))                 \
                        _Pre_valid_impl_)
#define _Deref_pre_opt_bytecount_(size)                                                                                \
    _SAL1_1_Source_(_Deref_pre_opt_bytecount_, (size),                                                                 \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecount_impl(size))               \
                        _Pre_valid_impl_)

// valid buffer extent is described by a constant expression
#define _Deref_pre_count_c_(size)                                                                                      \
    _SAL1_1_Source_(_Deref_pre_count_c_, (size),                                                                       \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__count_c_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_count_c_(size)                                                                                  \
    _SAL1_1_Source_(_Deref_pre_opt_count_c_, (size),                                                                   \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__count_c_impl(size))                 \
                        _Pre_valid_impl_)
#define _Deref_pre_bytecount_c_(size)                                                                                  \
    _SAL1_1_Source_(_Deref_pre_bytecount_c_, (size),                                                                   \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecount_c_impl(size))               \
                        _Pre_valid_impl_)
#define _Deref_pre_opt_bytecount_c_(size)                                                                              \
    _SAL1_1_Source_(_Deref_pre_opt_bytecount_c_, (size),                                                               \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecount_c_impl(size))             \
                        _Pre_valid_impl_)

// valid buffer extent is described by a complex expression
#define _Deref_pre_count_x_(size)                                                                                      \
    _SAL1_1_Source_(_Deref_pre_count_x_, (size),                                                                       \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__count_x_impl(size)) _Pre_valid_impl_)
#define _Deref_pre_opt_count_x_(size)                                                                                  \
    _SAL1_1_Source_(_Deref_pre_opt_count_x_, (size),                                                                   \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__count_x_impl(size))                 \
                        _Pre_valid_impl_)
#define _Deref_pre_bytecount_x_(size)                                                                                  \
    _SAL1_1_Source_(_Deref_pre_bytecount_x_, (size),                                                                   \
                    _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__bytecount_x_impl(size))               \
                        _Pre_valid_impl_)
#define _Deref_pre_opt_bytecount_x_(size)                                                                              \
    _SAL1_1_Source_(_Deref_pre_opt_bytecount_x_, (size),                                                               \
                    _Deref_pre1_impl_(__maybenull_impl_notref) _Deref_pre1_impl_(__bytecount_x_impl(size))             \
                        _Pre_valid_impl_)

// e.g. void PrintStringArray( _In_count_(cElems) _Deref_pre_valid_ const char * rgStr[], size_t cElems );
#define _Deref_pre_valid_                                                                                              \
    _SAL1_1_Source_(_Deref_pre_valid_, (), _Deref_pre1_impl_(__notnull_impl_notref) _Pre_valid_impl_)
#define _Deref_pre_opt_valid_                                                                                          \
    _SAL1_1_Source_(_Deref_pre_opt_valid_, (), _Deref_pre1_impl_(__maybenull_impl_notref) _Pre_valid_impl_)
...
#define _Deref_post_z_                                                                                                 \
    _SAL1_1_Source_(_Deref_post_z_, (),                                                                                \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__zterm_impl) _Post_valid_impl_)
#define _Deref_post_opt_z_                                                                                             \
    _SAL1_1_Source_(_Deref_post_opt_z_, (),                                                                            \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__zterm_impl) _Post_valid_impl_)
...
#define _Deref_post_opt_bytecap_x_(size)                                                                               \
    _SAL1_1_Source_(_Deref_post_opt_bytecap_x_, (size),                                                                \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__bytecap_x_impl(size)))

// convenience macros for nullterminated buffers with given capacity
#define _Deref_post_z_cap_(size)                                                                                       \
    _SAL1_1_Source_(_Deref_post_z_cap_, (size),                                                                        \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post2_impl_(__zterm_impl, __cap_impl(size))       \
                        _Post_valid_impl_)
#define _Deref_post_opt_z_cap_(size)                                                                                   \
    _SAL1_1_Source_(_Deref_post_opt_z_cap_, (size),                                                                    \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post2_impl_(__zterm_impl, __cap_impl(size))     \
                        _Post_valid_impl_)
#define _Deref_post_z_bytecap_(size)                                                                                   \
    _SAL1_1_Source_(_Deref_post_z_bytecap_, (size),                                                                    \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post2_impl_(__zterm_impl, __bytecap_impl(size))   \
                        _Post_valid_impl_)
#define _Deref_post_opt_z_bytecap_(size)                                                                               \
    _SAL1_1_Source_(_Deref_post_opt_z_bytecap_, (size),                                                                \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post2_impl_(__zterm_impl, __bytecap_impl(size)) \
                        _Post_valid_impl_)

#define _Deref_post_z_cap_c_(size)                                                                                     \
    _SAL1_1_Source_(_Deref_post_z_cap_c_, (size),                                                                      \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post2_impl_(__zterm_impl, __cap_c_impl(size))     \
                        _Post_valid_impl_)
#define _Deref_post_opt_z_cap_c_(size)                                                                                 \
    _SAL1_1_Source_(_Deref_post_opt_z_cap_c_, (size),                                                                  \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post2_impl_(__zterm_impl, __cap_c_impl(size))   \
                        _Post_valid_impl_)
#define _Deref_post_z_bytecap_c_(size)                                                                                 \
    _SAL1_1_Source_(_Deref_post_z_bytecap_c_, (size),                                                                  \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post2_impl_(__zterm_impl, __bytecap_c_impl(size)) \
                        _Post_valid_impl_)
#define _Deref_post_opt_z_bytecap_c_(size)                                                                             \
    _SAL1_1_Source_(_Deref_post_opt_z_bytecap_c_, (size),                                                              \
                    _Deref_post1_impl_(__maybenull_impl_notref)                                                        \
                        _Deref_post2_impl_(__zterm_impl, __bytecap_c_impl(size)) _Post_valid_impl_)

#define _Deref_post_z_cap_x_(size)                                                                                     \
    _SAL1_1_Source_(_Deref_post_z_cap_x_, (size),                                                                      \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post2_impl_(__zterm_impl, __cap_x_impl(size))     \
                        _Post_valid_impl_)
#define _Deref_post_opt_z_cap_x_(size)                                                                                 \
    _SAL1_1_Source_(_Deref_post_opt_z_cap_x_, (size),                                                                  \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post2_impl_(__zterm_impl, __cap_x_impl(size))   \
                        _Post_valid_impl_)
#define _Deref_post_z_bytecap_x_(size)                                                                                 \
    _SAL1_1_Source_(_Deref_post_z_bytecap_x_, (size),                                                                  \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post2_impl_(__zterm_impl, __bytecap_x_impl(size)) \
                        _Post_valid_impl_)
#define _Deref_post_opt_z_bytecap_x_(size)                                                                             \
    _SAL1_1_Source_(_Deref_post_opt_z_bytecap_x_, (size),                                                              \
                    _Deref_post1_impl_(__maybenull_impl_notref)                                                        \
                        _Deref_post2_impl_(__zterm_impl, __bytecap_x_impl(size)) _Post_valid_impl_)

// known capacity and valid but unknown readable extent
#define _Deref_post_valid_cap_(size)                                                                                   \
    _SAL1_1_Source_(_Deref_post_valid_cap_, (size),                                                                    \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__cap_impl(size)) _Post_valid_impl_)
...
#define _Deref_post_count_(size)                                                                                       \
    _SAL1_1_Source_(_Deref_post_count_, (size),                                                                        \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__count_impl(size))                   \
                        _Post_valid_impl_)
#define _Deref_post_opt_count_(size)                                                                                   \
    _SAL1_1_Source_(_Deref_post_opt_count_, (size),                                                                    \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__count_impl(size))                 \
                        _Post_valid_impl_)
#define _Deref_post_bytecount_(size)                                                                                   \
    _SAL1_1_Source_(_Deref_post_bytecount_, (size),                                                                    \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__bytecount_impl(size))               \
                        _Post_valid_impl_)
#define _Deref_post_opt_bytecount_(size)                                                                               \
    _SAL1_1_Source_(_Deref_post_opt_bytecount_, (size),                                                                \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__bytecount_impl(size))             \
                        _Post_valid_impl_)

// buffer capacity is described by a constant expression
#define _Deref_post_count_c_(size)                                                                                     \
    _SAL1_1_Source_(_Deref_post_count_c_, (size),                                                                      \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__count_c_impl(size))                 \
                        _Post_valid_impl_)
#define _Deref_post_opt_count_c_(size)                                                                                 \
    _SAL1_1_Source_(_Deref_post_opt_count_c_, (size),                                                                  \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__count_c_impl(size))               \
                        _Post_valid_impl_)
#define _Deref_post_bytecount_c_(size)                                                                                 \
    _SAL1_1_Source_(_Deref_post_bytecount_c_, (size),                                                                  \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__bytecount_c_impl(size))             \
                        _Post_valid_impl_)
#define _Deref_post_opt_bytecount_c_(size)                                                                             \
    _SAL1_1_Source_(_Deref_post_opt_bytecount_c_, (size),                                                              \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__bytecount_c_impl(size))           \
                        _Post_valid_impl_)

// buffer capacity is described by a complex expression
#define _Deref_post_count_x_(size)                                                                                     \
    _SAL1_1_Source_(_Deref_post_count_x_, (size),                                                                      \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__count_x_impl(size))                 \
                        _Post_valid_impl_)
#define _Deref_post_opt_count_x_(size)                                                                                 \
    _SAL1_1_Source_(_Deref_post_opt_count_x_, (size),                                                                  \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__count_x_impl(size))               \
                        _Post_valid_impl_)
#define _Deref_post_bytecount_x_(size)                                                                                 \
    _SAL1_1_Source_(_Deref_post_bytecount_x_, (size),                                                                  \
                    _Deref_post1_impl_(__notnull_impl_notref) _Deref_post1_impl_(__bytecount_x_impl(size))             \
                        _Post_valid_impl_)
#define _Deref_post_opt_bytecount_x_(size)                                                                             \
    _SAL1_1_Source_(_Deref_post_opt_bytecount_x_, (size),                                                              \
                    _Deref_post1_impl_(__maybenull_impl_notref) _Deref_post1_impl_(__bytecount_x_impl(size))           \
                        _Post_valid_impl_)

// e.g. void GetStrings( _Out_count_(cElems) _Deref_post_valid_ char* const rgStr[], size_t cElems );
#define _Deref_post_valid_                                                                                             \
    _SAL1_1_Source_(_Deref_post_valid_, (), _Deref_post1_impl_(__notnull_impl_notref) _Post_valid_impl_)
#define _Deref_post_opt_valid_                                                                                         \
    _SAL1_1_Source_(_Deref_post_opt_valid_, (), _Deref_post1_impl_(__maybenull_impl_notref) _Post_valid_impl_)
...
#define _Deref_ret_z_                                                                                                  \
    _SAL1_1_Source_(_Deref_ret_z_, (), _Deref_ret1_impl_(__notnull_impl_notref) _Deref_ret1_impl_(__zterm_impl))
#define _Deref_ret_opt_z_                                                                                              \
    _SAL1_1_Source_(_Deref_ret_opt_z_, (), _Deref_ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__zterm_impl))
...
// e.g. _Ret_opt_valid_ char* void* CloneSTR( _Pre_valid_ char* src );
...
#define _Ret_cap_(size)                                                                                                \
    _SAL1_1_Source_(_Ret_cap_, (size), _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__cap_impl(size)))
#define _Ret_opt_cap_(size)                                                                                            \
    _SAL1_1_Source_(_Ret_opt_cap_, (size), _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__cap_impl(size)))
#define _Ret_bytecap_(size)                                                                                            \
    _SAL1_1_Source_(_Ret_bytecap_, (size), _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__bytecap_impl(size)))
#define _Ret_opt_bytecap_(size)                                                                                        \
    _SAL1_1_Source_(_Ret_opt_bytecap_, (size), _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__bytecap_impl(size)))

// Buffer capacity is described by a constant expression
#define _Ret_cap_c_(size)                                                                                              \
    _SAL1_1_Source_(_Ret_cap_c_, (size), _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__cap_c_impl(size)))
#define _Ret_opt_cap_c_(size)                                                                                          \
    _SAL1_1_Source_(_Ret_opt_cap_c_, (size), _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__cap_c_impl(size)))
#define _Ret_bytecap_c_(size)                                                                                          \
    _SAL1_1_Source_(_Ret_bytecap_c_, (size), _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__bytecap_c_impl(size)))
...
#define _Ret_cap_x_(size)                                                                                              \
    _SAL1_1_Source_(_Ret_cap_x_, (size), _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__cap_x_impl(size)))
#define _Ret_opt_cap_x_(size)                                                                                          \
    _SAL1_1_Source_(_Ret_opt_cap_x_, (size), _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__cap_x_impl(size)))
#define _Ret_bytecap_x_(size)                                                                                          \
    _SAL1_1_Source_(_Ret_bytecap_x_, (size), _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__bytecap_x_impl(size)))
...
#define _Ret_z_cap_(size)                                                                                              \
    _SAL1_1_Source_(_Ret_z_cap_, (size),                                                                               \
                    _Ret1_impl_(__notnull_impl_notref) _Ret2_impl_(__zterm_impl, __cap_impl(size)) _Ret_valid_impl_)
#define _Ret_opt_z_cap_(size)                                                                                          \
    _SAL1_1_Source_(_Ret_opt_z_cap_, (size),                                                                           \
                    _Ret1_impl_(__maybenull_impl_notref) _Ret2_impl_(__zterm_impl, __cap_impl(size)) _Ret_valid_impl_)
#define _Ret_z_bytecap_(size)                                                                                          \
    _SAL1_1_Source_(_Ret_z_bytecap_, (size),                                                                           \
                    _Ret1_impl_(__notnull_impl_notref) _Ret2_impl_(__zterm_impl, __bytecap_impl(size))                 \
                        _Ret_valid_impl_)
#define _Ret_opt_z_bytecap_(size)                                                                                      \
    _SAL1_1_Source_(_Ret_opt_z_bytecap_, (size),                                                                       \
                    _Ret1_impl_(__maybenull_impl_notref) _Ret2_impl_(__zterm_impl, __bytecap_impl(size))               \
                        _Ret_valid_impl_)
...
#define _Ret_count_(size)                                                                                              \
    _SAL1_1_Source_(_Ret_count_, (size),                                                                               \
                    _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__count_impl(size)) _Ret_valid_impl_)
#define _Ret_opt_count_(size)                                                                                          \
    _SAL1_1_Source_(_Ret_opt_count_, (size),                                                                           \
                    _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__count_impl(size)) _Ret_valid_impl_)
#define _Ret_bytecount_(size)                                                                                          \
    _SAL1_1_Source_(_Ret_bytecount_, (size),                                                                           \
                    _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__bytecount_impl(size)) _Ret_valid_impl_)
#define _Ret_opt_bytecount_(size)                                                                                      \
    _SAL1_1_Source_(_Ret_opt_bytecount_, (size),                                                                       \
                    _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__bytecount_impl(size)) _Ret_valid_impl_)

// Valid Buffer extent is described by a constant expression
#define _Ret_count_c_(size)                                                                                            \
    _SAL1_1_Source_(_Ret_count_c_, (size),                                                                             \
                    _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__count_c_impl(size)) _Ret_valid_impl_)
#define _Ret_opt_count_c_(size)                                                                                        \
    _SAL1_1_Source_(_Ret_opt_count_c_, (size),                                                                         \
                    _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__count_c_impl(size)) _Ret_valid_impl_)
#define _Ret_bytecount_c_(size)                                                                                        \
    _SAL1_1_Source_(_Ret_bytecount_c_, (size),                                                                         \
                    _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__bytecount_c_impl(size)) _Ret_valid_impl_)
#define _Ret_opt_bytecount_c_(size)                                                                                    \
    _SAL1_1_Source_(_Ret_opt_bytecount_c_, (size),                                                                     \
                    _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__bytecount_c_impl(size)) _Ret_valid_impl_)

// Valid Buffer extent is described by a complex expression
#define _Ret_count_x_(size)                                                                                            \
    _SAL1_1_Source_(_Ret_count_x_, (size),                                                                             \
                    _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__count_x_impl(size)) _Ret_valid_impl_)
#define _Ret_opt_count_x_(size)                                                                                        \
    _SAL1_1_Source_(_Ret_opt_count_x_, (size),                                                                         \
                    _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__count_x_impl(size)) _Ret_valid_impl_)
#define _Ret_bytecount_x_(size)                                                                                        \
    _SAL1_1_Source_(_Ret_bytecount_x_, (size),                                                                         \
                    _Ret1_impl_(__notnull_impl_notref) _Ret1_impl_(__bytecount_x_impl(size)) _Ret_valid_impl_)
#define _Ret_opt_bytecount_x_(size)                                                                                    \
    _SAL1_1_Source_(_Ret_opt_bytecount_x_, (size),                                                                     \
                    _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__bytecount_x_impl(size)) _Ret_valid_impl_)

// return value is nullterminated and length is given by another parameter
#define _Ret_z_count_(size)                                                                                            \
    _SAL1_1_Source_(_Ret_z_count_, (size),                                                                             \
                    _Ret1_impl_(__notnull_impl_notref) _Ret2_impl_(__zterm_impl, __count_impl(size)) _Ret_valid_impl_)
#define _Ret_opt_z_count_(size)                                                                                        \
    _SAL1_1_Source_(_Ret_opt_z_count_, (size),                                                                         \
                    _Ret1_impl_(__maybenull_impl_notref) _Ret2_impl_(__zterm_impl, __count_impl(size))                 \
                        _Ret_valid_impl_)
#define _Ret_z_bytecount_(size)                                                                                        \
    _SAL1_1_Source_(_Ret_z_bytecount_, (size),                                                                         \
                    _Ret1_impl_(__notnull_impl_notref) _Ret2_impl_(__zterm_impl, __bytecount_impl(size))               \
                        _Ret_valid_impl_)
#define _Ret_opt_z_bytecount_(size)                                                                                    \
    _SAL1_1_Source_(_Ret_opt_z_bytecount_, (size),                                                                     \
                    _Ret1_impl_(__maybenull_impl_notref) _Ret2_impl_(__zterm_impl, __bytecount_impl(size))             \
                        _Ret_valid_impl_)


// _Pre_ annotations ---
#define _Pre_opt_z_                                                                                                    \
    _SAL1_1_Source_(_Pre_opt_z_, (), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__zterm_impl) _Pre_valid_impl_)
...
#define _Pre_cap_(size)                                                                                                \
    _SAL1_1_Source_(_Pre_cap_, (size), _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__cap_impl(size)))
#define _Pre_opt_cap_(size)                                                                                            \
    _SAL1_1_Source_(_Pre_opt_cap_, (size), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__cap_impl(size)))
#define _Pre_bytecap_(size)                                                                                            \
    _SAL1_1_Source_(_Pre_bytecap_, (size), _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__bytecap_impl(size)))
#define _Pre_opt_bytecap_(size)                                                                                        \
    _SAL1_1_Source_(_Pre_opt_bytecap_, (size), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecap_impl(size)))

// buffer capacity described by a constant expression
#define _Pre_cap_c_(size)                                                                                              \
    _SAL1_1_Source_(_Pre_cap_c_, (size), _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__cap_c_impl(size)))
#define _Pre_opt_cap_c_(size)                                                                                          \
    _SAL1_1_Source_(_Pre_opt_cap_c_, (size), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__cap_c_impl(size)))
#define _Pre_bytecap_c_(size)                                                                                          \
    _SAL1_1_Source_(_Pre_bytecap_c_, (size), _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__bytecap_c_impl(size)))
...
#define _Pre_cap_c_one_                                                                                                \
    _SAL1_1_Source_(_Pre_cap_c_one_, (), _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__cap_c_one_notref_impl))
#define _Pre_opt_cap_c_one_                                                                                            \
    _SAL1_1_Source_(_Pre_opt_cap_c_one_, (), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__cap_c_one_notref_impl))
...
#define _Pre_cap_for_(param)                                                                                           \
    _SAL1_1_Source_(_Pre_cap_for_, (param), _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__cap_for_impl(param)))
#define _Pre_opt_cap_for_(param)                                                                                       \
    _SAL1_1_Source_(_Pre_opt_cap_for_, (param), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__cap_for_impl(param)))

// buffer capacity described by a complex condition
#define _Pre_cap_x_(size)                                                                                              \
    _SAL1_1_Source_(_Pre_cap_x_, (size), _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__cap_x_impl(size)))
#define _Pre_opt_cap_x_(size)                                                                                          \
    _SAL1_1_Source_(_Pre_opt_cap_x_, (size), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__cap_x_impl(size)))
#define _Pre_bytecap_x_(size)                                                                                          \
    _SAL1_1_Source_(_Pre_bytecap_x_, (size), _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__bytecap_x_impl(size)))
...
#define _Pre_opt_ptrdiff_cap_(ptr)                                                                                     \
    _SAL1_1_Source_(_Pre_opt_ptrdiff_cap_, (ptr),                                                                      \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__cap_x_impl(__ptrdiff(ptr))))

// e.g. void AppendStr( _Pre_z_ const char* szFrom, _Pre_z_cap_(cchTo) _Post_z_ char* szTo, size_t cchTo );
#define _Pre_z_cap_(size)                                                                                              \
    _SAL1_1_Source_(_Pre_z_cap_, (size),                                                                               \
                    _Pre1_impl_(__notnull_impl_notref) _Pre2_impl_(__zterm_impl, __cap_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_z_cap_(size)                                                                                          \
    _SAL1_1_Source_(_Pre_opt_z_cap_, (size),                                                                           \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre2_impl_(__zterm_impl, __cap_impl(size)) _Pre_valid_impl_)
...
#define _Pre_z_cap_c_(size)                                                                                            \
    _SAL1_1_Source_(_Pre_z_cap_c_, (size),                                                                             \
                    _Pre1_impl_(__notnull_impl_notref) _Pre2_impl_(__zterm_impl, __cap_c_impl(size)) _Pre_valid_impl_)
...
#define _Pre_z_cap_x_(size)                                                                                            \
    _SAL1_1_Source_(_Pre_z_cap_x_, (size),                                                                             \
                    _Pre1_impl_(__notnull_impl_notref) _Pre2_impl_(__zterm_impl, __cap_x_impl(size)) _Pre_valid_impl_)
...
#define _Pre_valid_cap_(size)                                                                                          \
    _SAL1_1_Source_(_Pre_valid_cap_, (size),                                                                           \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__cap_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_valid_cap_(size)                                                                                      \
    _SAL1_1_Source_(_Pre_opt_valid_cap_, (size),                                                                       \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__cap_impl(size)) _Pre_valid_impl_)
#define _Pre_valid_bytecap_(size)                                                                                      \
    _SAL1_1_Source_(_Pre_valid_bytecap_, (size),                                                                       \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__bytecap_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_valid_bytecap_(size)                                                                                  \
    _SAL1_1_Source_(_Pre_opt_valid_bytecap_, (size),                                                                   \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecap_impl(size)) _Pre_valid_impl_)

#define _Pre_valid_cap_c_(size)                                                                                        \
    _SAL1_1_Source_(_Pre_valid_cap_c_, (size),                                                                         \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__cap_c_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_valid_cap_c_(size)                                                                                    \
    _SAL1_1_Source_(_Pre_opt_valid_cap_c_, (size),                                                                     \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__cap_c_impl(size)) _Pre_valid_impl_)
#define _Pre_valid_bytecap_c_(size)                                                                                    \
    _SAL1_1_Source_(_Pre_valid_bytecap_c_, (size),                                                                     \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__bytecap_c_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_valid_bytecap_c_(size)                                                                                \
    _SAL1_1_Source_(_Pre_opt_valid_bytecap_c_, (size),                                                                 \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecap_c_impl(size)) _Pre_valid_impl_)

#define _Pre_valid_cap_x_(size)                                                                                        \
    _SAL1_1_Source_(_Pre_valid_cap_x_, (size),                                                                         \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__cap_x_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_valid_cap_x_(size)                                                                                    \
    _SAL1_1_Source_(_Pre_opt_valid_cap_x_, (size),                                                                     \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__cap_x_impl(size)) _Pre_valid_impl_)
#define _Pre_valid_bytecap_x_(size)                                                                                    \
    _SAL1_1_Source_(_Pre_valid_bytecap_x_, (size),                                                                     \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__bytecap_x_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_valid_bytecap_x_(size)                                                                                \
    _SAL1_1_Source_(_Pre_opt_valid_bytecap_x_, (size),                                                                 \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecap_x_impl(size)) _Pre_valid_impl_)

// e.g. void AppendCharRange( _Pre_count_(cchFrom) const char* rgFrom, size_t cchFrom, _Out_z_cap_(cchTo) char* szTo,
// size_t cchTo ); Valid buffer extent described by another parameter
#define _Pre_count_(size)                                                                                              \
    _SAL1_1_Source_(_Pre_count_, (size),                                                                               \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__count_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_count_(size)                                                                                          \
    _SAL1_1_Source_(_Pre_opt_count_, (size),                                                                           \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__count_impl(size)) _Pre_valid_impl_)
#define _Pre_bytecount_(size)                                                                                          \
    _SAL1_1_Source_(_Pre_bytecount_, (size),                                                                           \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__bytecount_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_bytecount_(size)                                                                                      \
    _SAL1_1_Source_(_Pre_opt_bytecount_, (size),                                                                       \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecount_impl(size)) _Pre_valid_impl_)

// Valid buffer extent described by a constant expression
#define _Pre_count_c_(size)                                                                                            \
    _SAL1_1_Source_(_Pre_count_c_, (size),                                                                             \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__count_c_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_count_c_(size)                                                                                        \
    _SAL1_1_Source_(_Pre_opt_count_c_, (size),                                                                         \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__count_c_impl(size)) _Pre_valid_impl_)
#define _Pre_bytecount_c_(size)                                                                                        \
    _SAL1_1_Source_(_Pre_bytecount_c_, (size),                                                                         \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__bytecount_c_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_bytecount_c_(size)                                                                                    \
    _SAL1_1_Source_(_Pre_opt_bytecount_c_, (size),                                                                     \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecount_c_impl(size)) _Pre_valid_impl_)

// Valid buffer extent described by a complex expression
#define _Pre_count_x_(size)                                                                                            \
    _SAL1_1_Source_(_Pre_count_x_, (size),                                                                             \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__count_x_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_count_x_(size)                                                                                        \
    _SAL1_1_Source_(_Pre_opt_count_x_, (size),                                                                         \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__count_x_impl(size)) _Pre_valid_impl_)
#define _Pre_bytecount_x_(size)                                                                                        \
    _SAL1_1_Source_(_Pre_bytecount_x_, (size),                                                                         \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__bytecount_x_impl(size)) _Pre_valid_impl_)
#define _Pre_opt_bytecount_x_(size)                                                                                    \
    _SAL1_1_Source_(_Pre_opt_bytecount_x_, (size),                                                                     \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecount_x_impl(size)) _Pre_valid_impl_)

// Valid buffer extent described by the difference to another pointer parameter
#define _Pre_ptrdiff_count_(ptr)                                                                                       \
    _SAL1_1_Source_(_Pre_ptrdiff_count_, (ptr),                                                                        \
                    _Pre1_impl_(__notnull_impl_notref) _Pre1_impl_(__count_x_impl(__ptrdiff(ptr))) _Pre_valid_impl_)
#define _Pre_opt_ptrdiff_count_(ptr)                                                                                   \
    _SAL1_1_Source_(_Pre_opt_ptrdiff_count_, (ptr),                                                                    \
                    _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__count_x_impl(__ptrdiff(ptr))) _Pre_valid_impl_)
...
#define _Post_bytecount_(size)                                                                                         \
    _SAL1_1_Source_(_Post_bytecount_, (size), _Post1_impl_(__bytecount_impl(size)) _Post_valid_impl_)
...
#define _Post_bytecount_c_(size)                                                                                       \
    _SAL1_1_Source_(_Post_bytecount_c_, (size), _Post1_impl_(__bytecount_c_impl(size)) _Post_valid_impl_)
...
#define _Post_bytecount_x_(size)                                                                                       \
    _SAL1_1_Source_(_Post_bytecount_x_, (size), _Post1_impl_(__bytecount_x_impl(size)) _Post_valid_impl_)

// e.g. size_t CopyStr( _In_z_ const char* szFrom, _Pre_cap_(cch) _Post_z_count_(return+1) char* szFrom, size_t cchFrom
// );
#define _Post_z_count_(size)                                                                                           \
    _SAL1_1_Source_(_Post_z_count_, (size), _Post2_impl_(__zterm_impl, __count_impl(size)) _Post_valid_impl_)
#define _Post_z_bytecount_(size)                                                                                       \
    _SAL1_1_Source_(_Post_z_bytecount_, (size), _Post2_impl_(__zterm_impl, __bytecount_impl(size)) _Post_valid_impl_)
#define _Post_z_count_c_(size)                                                                                         \
    _SAL1_1_Source_(_Post_z_count_c_, (size), _Post2_impl_(__zterm_impl, __count_c_impl(size)) _Post_valid_impl_)
...
#define _Post_z_count_x_(size)                                                                                         \
    _SAL1_1_Source_(_Post_z_count_x_, (size), _Post2_impl_(__zterm_impl, __count_x_impl(size)) _Post_valid_impl_)
...
#define _Prepost_opt_bytecount_(size)                                                                                  \
    _SAL1_1_Source_(_Prepost_opt_bytecount_, (size), _Pre_opt_bytecount_(size) _Post_bytecount_(size))
...
#define _Prepost_opt_bytecount_c_(size)                                                                                \
    _SAL1_1_Source_(_Prepost_opt_bytecount_c_, (size), _Pre_opt_bytecount_c_(size) _Post_bytecount_c_(size))
...
#define _Prepost_opt_bytecount_x_(size)                                                                                \
    _SAL1_1_Source_(_Prepost_opt_bytecount_x_, (size), _Pre_opt_bytecount_x_(size) _Post_bytecount_x_(size))
...
#define _Deref_prepost_opt_cap_(size)                                                                                  \
    _SAL1_1_Source_(_Deref_prepost_opt_cap_, (size), _Deref_pre_opt_cap_(size) _Deref_post_opt_cap_(size))
#define _Deref_prepost_bytecap_(size)                                                                                  \
    _SAL1_1_Source_(_Deref_prepost_bytecap_, (size), _Deref_pre_bytecap_(size) _Deref_post_bytecap_(size))
#define _Deref_prepost_opt_bytecap_(size)                                                                              \
    _SAL1_1_Source_(_Deref_prepost_opt_bytecap_, (size), _Deref_pre_opt_bytecap_(size) _Deref_post_opt_bytecap_(size))
...
#define _Deref_prepost_opt_cap_x_(size)                                                                                \
    _SAL1_1_Source_(_Deref_prepost_opt_cap_x_, (size), _Deref_pre_opt_cap_x_(size) _Deref_post_opt_cap_x_(size))
#define _Deref_prepost_bytecap_x_(size)                                                                                \
    _SAL1_1_Source_(_Deref_prepost_bytecap_x_, (size), _Deref_pre_bytecap_x_(size) _Deref_post_bytecap_x_(size))
...
#define _Deref_prepost_opt_z_cap_(size)                                                                                \
    _SAL1_1_Source_(_Deref_prepost_opt_z_cap_, (size), _Deref_pre_opt_z_cap_(size) _Deref_post_opt_z_cap_(size))
#define _Deref_prepost_z_bytecap_(size)                                                                                \
    _SAL1_1_Source_(_Deref_prepost_z_bytecap_, (size), _Deref_pre_z_bytecap_(size) _Deref_post_z_bytecap_(size))
...
#define _Deref_prepost_valid_cap_(size)                                                                                \
    _SAL1_1_Source_(_Deref_prepost_valid_cap_, (size), _Deref_pre_valid_cap_(size) _Deref_post_valid_cap_(size))
...
#define _Deref_prepost_valid_cap_x_(size)                                                                              \
    _SAL1_1_Source_(_Deref_prepost_valid_cap_x_, (size), _Deref_pre_valid_cap_x_(size) _Deref_post_valid_cap_x_(size))
...
#define _Deref_prepost_opt_count_(size)                                                                                \
    _SAL1_1_Source_(_Deref_prepost_opt_count_, (size), _Deref_pre_opt_count_(size) _Deref_post_opt_count_(size))
#define _Deref_prepost_bytecount_(size)                                                                                \
    _SAL1_1_Source_(_Deref_prepost_bytecount_, (size), _Deref_pre_bytecount_(size) _Deref_post_bytecount_(size))
...
#define _Deref_prepost_count_x_(size)                                                                                  \
    _SAL1_1_Source_(_Deref_prepost_count_x_, (size), _Deref_pre_count_x_(size) _Deref_post_count_x_(size))
#define _Deref_prepost_opt_count_x_(size)                                                                              \
    _SAL1_1_Source_(_Deref_prepost_opt_count_x_, (size), _Deref_pre_opt_count_x_(size) _Deref_post_opt_count_x_(size))
#define _Deref_prepost_bytecount_x_(size)                                                                              \
    _SAL1_1_Source_(_Deref_prepost_bytecount_x_, (size), _Deref_pre_bytecount_x_(size) _Deref_post_bytecount_x_(size))
...
/*
 ...
 <>      : No buffer size is given. If the type specifies the buffer size (such as
             with char* and char16_t*), that amount is used. Otherwise, the buffer is one
...
#define __out_ecount_z(size)                                                                                           \
    _SAL1_Source_(__out_ecount_z, (size), __ecount(size) __post __refparam __post __nullterminated)
#define __out_bcount_z(size)                                                                                           \
    _SAL1_Source_(__out_bcount_z, (size), __bcount(size) __post __refparam __post __nullterminated)
...
#define __inout_bcount_z(size)                                                                                         \
    _SAL1_Source_(__inout_bcount_z, (size), __inout_bcount(size) __pre __nullterminated __post __nullterminated)
...
#define __out_ecount_full_z_opt(size)                                                                                  \
    _SAL1_Source_(__out_ecount_full_z_opt, (size), __out_ecount_full_opt(size) __post __nullterminated)
#define __out_bcount_full_z_opt(size)                                                                                  \
    _SAL1_Source_(__out_bcount_full_z_opt, (size), __out_bcount_full_opt(size) __post __nullterminated)
...
#define __inout_ecount_z_opt(size)                                                                                     \
    _SAL1_Source_(__inout_ecount_z_opt, (size), __inout_ecount_opt(size) __pre __nullterminated __post __nullterminated)
#define __inout_ecount_z_opt(size)                                                                                     \
    _SAL1_Source_(__inout_ecount_z_opt, (size), __inout_ecount_opt(size) __pre __nullterminated __post __nullterminated)
...
#define __deref_ecount(size)                                                                                           \
    _SAL1_Source_(__deref_ecount, (size),                                                                              \
...
#define __deref_bcount(size)                                                                                           \
    _SAL1_Source_(__deref_bcount, (size),                                                                              \
                  _Notref_ __ecount(1) __post _Notref_ __elem_readableTo(1)                                            \
...
#define __deref_out_ecount_z(size)                                                                                     \
    _SAL1_Source_(__deref_out_ecount_z, (size), __deref_out_ecount(size) __post __deref __nullterminated)
#define __deref_out_bcount_z(size)                                                                                     \
    _SAL1_Source_(__deref_out_bcount_z, (size), __deref_out_bcount(size) __post __deref __nullterminated)
...
#define __deref_inout                                                                                                  \
    _SAL1_Source_(__deref_inout, (),                                                                                   \
                  _Notref_ __notnull _Notref_ __elem_readableTo(1) __pre __deref __post _Notref_ __deref __refparam)
#define __deref_inout_z                                                                                                \
    _SAL1_Source_(__deref_inout_z, (),                                                                                 \
...
#define __deref_inout_ecount(size)                                                                                     \
    _SAL1_Source_(__deref_inout_ecount, (size),                                                                        \
                  __deref_inout __pre __deref __elem_writableTo(size) __post _Notref_ __deref __elem_writableTo(size))
#define __deref_inout_bcount(size)                                                                                     \
    _SAL1_Source_(__deref_inout_bcount, (size),                                                                        \
                  __deref_inout __pre __deref __byte_writableTo(size) __post _Notref_ __deref __byte_writableTo(size))
...
#define __deref_inout_ecount_z(size)                                                                                   \
    _SAL1_Source_(__deref_inout_ecount_z, (size),                                                                      \
                  __deref_inout_ecount(size) __pre __deref __nullterminated __post __deref __nullterminated)
#define __deref_inout_bcount_z(size)                                                                                   \
    _SAL1_Source_(__deref_inout_bcount_z, (size),                                                                      \
                  __deref_inout_bcount(size) __pre __deref __nullterminated __post __deref __nullterminated)
...
#define __deref_out_ecount_opt(size)                                                                                   \
    _SAL1_Source_(__deref_out_ecount_opt, (size), __deref_out_ecount(size) __post_deref_except_maybenull)
#define __deref_out_bcount_opt(size)                                                                                   \
    _SAL1_Source_(__deref_out_bcount_opt, (size), __deref_out_bcount(size) __post_deref_except_maybenull)
...
#define __deref_out_ecount_full_opt(size)                                                                              \
    _SAL1_Source_(__deref_out_ecount_full_opt, (size), __deref_out_ecount_full(size) __post_deref_except_maybenull)
#define __deref_out_bcount_full_opt(size)                                                                              \
    _SAL1_Source_(__deref_out_bcount_full_opt, (size), __deref_out_bcount_full(size) __post_deref_except_maybenull)
#define __deref_out_z_opt _SAL1_Source_(__deref_out_z_opt, (), _Outptr_result_maybenull_z_)
#define __deref_out_ecount_z_opt(size)                                                                                 \
    _SAL1_Source_(__deref_out_ecount_z_opt, (size), __deref_out_ecount_opt(size) __post __deref __nullterminated)
#define __deref_out_bcount_z_opt(size)                                                                                 \
    _SAL1_Source_(__deref_out_bcount_z_opt, (size), __deref_out_bcount_opt(size) __post __deref __nullterminated)
...
#define __deref_inout_opt                                                                                              \
    _SAL1_Source_(__deref_inout_opt, (), __deref_inout __pre_deref_except_maybenull __post_deref_except_maybenull)
#define __deref_inout_ecount_opt(size)                                                                                 \
    _SAL1_Source_(__deref_inout_ecount_opt, (size),                                                                    \
                  __deref_inout_ecount(size) __pre_deref_except_maybenull __post_deref_except_maybenull)
#define __deref_inout_bcount_opt(size)                                                                                 \
    _SAL1_Source_(__deref_inout_bcount_opt, (size),                                                                    \
                  __deref_inout_bcount(size) __pre_deref_except_maybenull __post_deref_except_maybenull)
#define __deref_inout_ecount_part_opt(size, length)                                                                    \
    _SAL1_Source_(__deref_inout_ecount_part_opt, (size, length),                                                       \
                  __deref_inout_ecount_part(size, length) __pre_deref_except_maybenull __post_deref_except_maybenull)
#define __deref_inout_bcount_part_opt(size, length)                                                                    \
    _SAL1_Source_(__deref_inout_bcount_part_opt, (size, length),                                                       \
                  __deref_inout_bcount_part(size, length) __pre_deref_except_maybenull __post_deref_except_maybenull)
#define __deref_inout_ecount_full_opt(size)                                                                            \
    _SAL1_Source_(__deref_inout_ecount_full_opt, (size),                                                               \
                  __deref_inout_ecount_full(size) __pre_deref_except_maybenull __post_deref_except_maybenull)
#define __deref_inout_bcount_full_opt(size)                                                                            \
    _SAL1_Source_(__deref_inout_bcount_full_opt, (size),                                                               \
                  __deref_inout_bcount_full(size) __pre_deref_except_maybenull __post_deref_except_maybenull)
#define __deref_inout_z_opt                                                                                            \
    _SAL1_Source_(__deref_inout_z_opt, (),                                                                             \
...
#define __deref_inout_ecount_z_opt(size)                                                                               \
    _SAL1_Source_(__deref_inout_ecount_z_opt, (size),                                                                  \
                  __deref_inout_ecount_opt(size) __pre __deref __nullterminated __post __deref __nullterminated)
#define __deref_inout_bcount_z_opt(size)                                                                               \
    _SAL1_Source_(__deref_inout_bcount_z_opt, (size),                                                                  \
                  __deref_inout_bcount_opt(size) __pre __deref __nullterminated __post __deref __nullterminated)
...
#define __deref_opt_out_ecount_full(size)                                                                              \
    _SAL1_Source_(__deref_opt_out_ecount_full, (size), __deref_out_ecount_full(size) __pre_except_maybenull)
#define __deref_opt_out_bcount_full(size)                                                                              \
    _SAL1_Source_(__deref_opt_out_bcount_full, (size), __deref_out_bcount_full(size) __pre_except_maybenull)
#define __deref_opt_inout _SAL1_Source_(__deref_opt_inout, (), _Inout_opt_)
#define __deref_opt_inout_ecount(size)                                                                                 \
    _SAL1_Source_(__deref_opt_inout_ecount, (size), __deref_inout_ecount(size) __pre_except_maybenull)
#define __deref_opt_inout_bcount(size)                                                                                 \
    _SAL1_Source_(__deref_opt_inout_bcount, (size), __deref_inout_bcount(size) __pre_except_maybenull)
...
#define __deref_opt_inout_ecount_full(size)                                                                            \
    _SAL1_Source_(__deref_opt_inout_ecount_full, (size), __deref_inout_ecount_full(size) __pre_except_maybenull)
#define __deref_opt_inout_bcount_full(size)                                                                            \
    _SAL1_Source_(__deref_opt_inout_bcount_full, (size), __deref_inout_bcount_full(size) __pre_except_maybenull)
#define __deref_opt_inout_z                                                                                            \
    _SAL1_Source_(__deref_opt_inout_z, (),                                                                             \
...
#define __deref_opt_inout_ecount_z(size)                                                                               \
    _SAL1_Source_(__deref_opt_inout_ecount_z, (size),                                                                  \
                  __deref_opt_inout_ecount(size) __pre __deref __nullterminated __post __deref __nullterminated)
#define __deref_opt_inout_bcount_z(size)                                                                               \
    _SAL1_Source_(__deref_opt_inout_bcount_z, (size),                                                                  \
                  __deref_opt_inout_bcount(size) __pre __deref __nullterminated __post __deref __nullterminated)
...
#define __deref_opt_out_ecount_opt(size)                                                                               \
    _SAL1_Source_(__deref_opt_out_ecount_opt, (size), __deref_out_ecount_opt(size) __pre_except_maybenull)
#define __deref_opt_out_bcount_opt(size)                                                                               \
    _SAL1_Source_(__deref_opt_out_bcount_opt, (size), __deref_out_bcount_opt(size) __pre_except_maybenull)
...
#define __deref_opt_out_ecount_full_opt(size)                                                                          \
    _SAL1_Source_(__deref_opt_out_ecount_full_opt, (size), __deref_out_ecount_full_opt(size) __pre_except_maybenull)
#define __deref_opt_out_bcount_full_opt(size)                                                                          \
    _SAL1_Source_(__deref_opt_out_bcount_full_opt, (size), __deref_out_bcount_full_opt(size) __pre_except_maybenull)
#define __deref_opt_out_z_opt                                                                                          \
    _SAL1_Source_(__deref_opt_out_z_opt, (),                                                                           \
                  __post __deref __refparam __pre_except_maybenull __pre_deref_except_maybenull                        \
...
#define __deref_opt_inout_ecount_opt(size)                                                                             \
    _SAL1_Source_(__deref_opt_inout_ecount_opt, (size), __deref_inout_ecount_opt(size) __pre_except_maybenull)
#define __deref_opt_inout_bcount_opt(size)                                                                             \
    _SAL1_Source_(__deref_opt_inout_bcount_opt, (size), __deref_inout_bcount_opt(size) __pre_except_maybenull)
...
#define __deref_opt_inout_ecount_full_opt(size)                                                                        \
    _SAL1_Source_(__deref_opt_inout_ecount_full_opt, (size), __deref_inout_ecount_full_opt(size) __pre_except_maybenull)
#define __deref_opt_inout_bcount_full_opt(size)                                                                        \
    _SAL1_Source_(__deref_opt_inout_bcount_full_opt, (size), __deref_inout_bcount_full_opt(size) __pre_except_maybenull)
#define __deref_opt_inout_z_opt                                                                                        \
    _SAL1_Source_(__deref_opt_inout_z_opt, (),                                                                         \
...
#define __deref_opt_inout_ecount_z_opt(size)                                                                           \
    _SAL1_Source_(__deref_opt_inout_ecount_z_opt, (size),                                                              \
                  __deref_opt_inout_ecount_opt(size) __pre __deref __nullterminated __post __deref __nullterminated)
#define __deref_opt_inout_bcount_z_opt(size)                                                                           \
    _SAL1_Source_(__deref_opt_inout_bcount_z_opt, (size),                                                              \
                  __deref_opt_inout_bcount_opt(size) __pre __deref __nullterminated __post __deref __nullterminated)
