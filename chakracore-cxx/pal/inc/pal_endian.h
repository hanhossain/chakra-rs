...
#define GET_UNALIGNED_64(_pObject)  (*(unsigned long UNALIGNED *)(_pObject))
...
#define SET_UNALIGNED_64(_pObject, _Value)  (*(UNALIGNED unsigned long *)(_pObject)) = (unsigned long)(_Value)
