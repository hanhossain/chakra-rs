...
int swprintf_s(char16_t *string, size_t sizeInWords, const char16_t *format, ...)
{
    int ret;
    va_list arglist;
...
int _snwprintf_s(char16_t *string, size_t sizeInWords, size_t count, const char16_t *format, ...)
{
    int ret;
    va_list arglist;
