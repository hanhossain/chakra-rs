...
namespace chakracore::jsrt
{
    ...
    /// </returns>
    JsErrorCode JsCreateEnhancedFunction(
    ...
    ///     The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
    /// </returns>
    JsErrorCode JsInitializeModuleRecord(
    ...
    ///     The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
    /// </returns>
    JsErrorCode JsModuleEvaluation(
        _In_ JsModuleRecord requestModule,
    ...
    ///     The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
    /// </returns>
    JsErrorCode JsGetModuleHostInfo(
        _In_  JsModuleRecord requestModule,
        _In_ JsModuleHostInfoKind moduleHostInfo,
    ...
    ///     The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
    /// </returns>
    JsErrorCode JsGetAndClearExceptionWithMetadata(
