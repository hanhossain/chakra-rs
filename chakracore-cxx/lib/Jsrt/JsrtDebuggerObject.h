...
public:
    ...
    bool Evaluate(Js::ScriptContext* scriptContext, const char16_t *source, int sourceLength, bool isLibraryCode, bool forceSetValueProp, Js::DynamicObject** evalResult);
