...
namespace Wasm
{
    ...
    public:
        ...
        void SetName(const char16_t *name, uint32_t nameLength)
        {
            m_name = name;
...
#if DBG_DUMP
        typename WriteBarrierFieldTypeTraits<WasmImport *, _no_write_barrier_policy, _no_write_barrier_policy>::Type
    ...
    private:
        typename WriteBarrierFieldTypeTraits<ArenaAllocator *, _no_write_barrier_policy, _no_write_barrier_policy>::Type
            m_alloc;
