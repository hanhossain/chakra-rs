...
namespace Js
{
    struct EmptyWasmByteCodeWriter : public IWasmByteCodeWriter
    {
        ...
        virtual void AsmSimdTypedArr(OpCodeAsmJs op, RegSlot value, uint32 slotIndex, uint8_t dataWidth, ArrayBufferView::ViewType viewType, uint32 offset = 0) override {};
