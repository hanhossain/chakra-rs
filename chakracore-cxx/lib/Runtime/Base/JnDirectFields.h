...
#endif
ENTRY_SYMBOL(_symbolAsyncIterator, u"Symbol.asyncIterator")
ENTRY_SYMBOL(_symbolHasInstance, u"Symbol.hasInstance")
ENTRY_SYMBOL(_symbolIsConcatSpreadable, u"Symbol.isConcatSpreadable")
ENTRY_SYMBOL(_symbolIterator, u"Symbol.iterator")
ENTRY_SYMBOL(_symbolMatch, u"Symbol.match")
ENTRY_SYMBOL(_symbolReplace, u"Symbol.replace")
ENTRY_SYMBOL(_symbolSearch, u"Symbol.search")
ENTRY_SYMBOL(_symbolSplit, u"Symbol.split")
ENTRY_SYMBOL(_symbolSpecies, u"Symbol.species")
ENTRY_SYMBOL(_symbolToPrimitive, u"Symbol.toPrimitive")
ENTRY_SYMBOL(_symbolToStringTag, u"Symbol.toStringTag")
ENTRY_SYMBOL(_symbolUnscopables, u"Symbol.unscopables")
...
ENTRY(blink)
ENTRY(bold)
ENTRY2(boolean_, u"boolean") // "boolean" cannot be an identifier in C++ so using "boolean_" instead
ENTRY(Boolean)
ENTRY(JsBuiltIn)
ENTRY(call)
...
ENTRY(cast)
ENTRY(cause)
ENTRY2(catch_, u"catch") // "catch" cannot be an identifier in C++ so using "catch_" instead
ENTRY(charAt)
ENTRY(charCodeAt)
ENTRY(codePointAt)
ENTRY(clear)
...
ENTRY2(default_, u"default")
ENTRY2(delete_, u"delete") // "delete" cannot be an identifier in C++ so using "delete_" instead
ENTRY2(star_, u"*")
...
ENTRY(every)
ENTRY(exec)
ENTRY2(false_, u"false") // "false" cannot be an identifier in C++ so using "false_" instead
ENTRY(flags)
ENTRY(flat)
ENTRY(flatMap)
ENTRY(fill)
...
ENTRY(fontcolor)
ENTRY(fontsize)
ENTRY2(for_, u"for") // "for" cannot be an identifier in C++ so using "for_" instead
ENTRY(forEach)
ENTRY(freeze)
ENTRY(from)
ENTRY(fromCharCode)
...
ENTRY(object)
ENTRY(Object)
ENTRY2(object_Arguments, u"[object Arguments]")
ENTRY2(object_Array, u"[object Array]")
ENTRY2(object_Boolean, u"[object Boolean]")
ENTRY2(object_Date, u"[object Date]")
ENTRY2(object_Error, u"[object Error]")
ENTRY2(object_Function, u"[object Function]")
ENTRY2(object_Number, u"[object Number]")
ENTRY2(object_Object, u"[object Object]")
ENTRY2(object_RegExp, u"[object RegExp]")
ENTRY2(object_String, u"[object String]")
ENTRY(of)
ENTRY(parse)
ENTRY(parseFloat)
ENTRY(parseInt)
...
ENTRY(replace)
ENTRY(resolve)
ENTRY2(return_, u"return") // "return" cannot be an identifier in C++ so using "return_" instead
ENTRY(reverse)
ENTRY(revocable)
ENTRY(revoke)
ENTRY(RegExp)
...
ENTRY(test)
ENTRY(then)
ENTRY2(throw_, u"throw") // "throw" cannot be an identifier in C++ so using "throw_" instead
ENTRY(toDateString)
ENTRY(toExponential)
ENTRY(toFixed)
ENTRY(toISOString)
...
ENTRY(padStart)
ENTRY(padEnd)
ENTRY2(true_, u"true") // "true_" cannot be an identifier in C++ so using "true_" instead
ENTRY(TypeError)
ENTRY(undefined)
ENTRY(unescape)
ENTRY(unknown)
...
ENTRY(rightContext)
ENTRY(options)
ENTRY2(__instance, u"$__instance")
ENTRY2(Small, u"small")
ENTRY2($Ampersand, u"$&")
ENTRY2($Plus, u"$+")
ENTRY2($BackTick, u"$`")
ENTRY2($Tick, u"$\'")
...
ENTRY_SYMBOL(_intlFallbackSymbol, u"Intl.FallbackSymbol")
...
ENTRY2(_RuntimeFunctionNameId_asyncIterator, u"[Symbol.asyncIterator]")
ENTRY2(_RuntimeFunctionNameId_hasInstance, u"[Symbol.hasInstance]")
ENTRY2(_RuntimeFunctionNameId_toStringTag, u"[Symbol.toStringTag]")
ENTRY2(_RuntimeFunctionNameId_toPrimitive, u"[Symbol.toPrimitive]")
ENTRY2(_RuntimeFunctionNameId_iterator, u"[Symbol.iterator]")
ENTRY2(_RuntimeFunctionNameId_species, u"[Symbol.species]")
ENTRY2(_RuntimeFunctionNameId_replace, u"[Symbol.replace]")
ENTRY2(_RuntimeFunctionNameId_search, u"[Symbol.search]")
ENTRY2(_RuntimeFunctionNameId_match, u"[Symbol.match]")
ENTRY2(_RuntimeFunctionNameId_split, u"[Symbol.split]")
...
ENTRY2(_this, u"*this*")
ENTRY2(_super, u"*super*")
ENTRY2(_superConstructor, u"*superconstructor*")
ENTRY2(_newTarget, u"*new.target*")
