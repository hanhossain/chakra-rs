...
namespace TTD
{
    ...
    public:
        ...
        void WritePathToConsole(ThreadContext* threadContext, bool printNewline, _Out_writes_z_(namebuffLength) char16_t* namebuff, charcount_t namebuffLength) const;
    };
