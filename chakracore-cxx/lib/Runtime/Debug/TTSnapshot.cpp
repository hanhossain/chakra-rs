...
namespace TTD
{
        ...
        GCTime(gcTime), MarkTime(0.0), ExtractTime(0.0)
    {
        ...
        this->m_snapObjectVTableArray[(uint32_t)NSSnapObjects::SnapObjectType::SnapNativeIntArrayObject] = { &NSSnapObjects::DoObjectInflation_SnapArrayInfo<int32_t, NSSnapObjects::SnapObjectType::SnapNativeIntArrayObject>, &NSSnapObjects::DoAddtlValueInstantiation_SnapArrayInfo<int32_t, int32_t, NSSnapObjects::SnapObjectType::SnapNativeIntArrayObject>, &NSSnapObjects::EmitAddtlInfo_SnapArrayInfo<int32_t, NSSnapObjects::SnapObjectType::SnapNativeIntArrayObject>, &NSSnapObjects::ParseAddtlInfo_SnapArrayInfo<int32_t, NSSnapObjects::SnapObjectType::SnapNativeIntArrayObject> };
