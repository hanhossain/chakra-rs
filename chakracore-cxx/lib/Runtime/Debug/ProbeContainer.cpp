...
namespace Js
{
    ...
    void ProbeContainer::UpdateFramePointers(bool fMatchWithCurrentScriptContext, unsigned long dispatchHaltFrameAddress)
    {
        ...
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::UpdateFramePointers: detected %d frames (this=%p, fMatchWithCurrentScriptContext=%d)\n",
    ...
    bool ProbeContainer::InitializeLocation(InterpreterHaltState* pHaltState, bool fMatchWithCurrentScriptContext)
    {
        ...
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::InitializeLocation (end): this=%p, pHaltState=%p, fMatch=%d, topFrame=%p\n",
    ...
    {
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DestroyLocation (start): this=%p, IsNextStatementChanged=%d, haltCallbackProbe=%p\n",
    ...
    {
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchStepHandler: start: this=%p, pHaltState=%p, pOriginalOpcode=0x%x\n", this, pHaltState, pOriginalOpcode);
        ...
        TryFinally([&]()
          {
            ...
            OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchStepHandler: initialized location: pHaltState=%p, pHaltState->IsValid()=%d\n",
        ...
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchStepHandler: end: pHaltState=%p\n", pHaltState);
    }

    void ProbeContainer::DispatchAsyncBreak(InterpreterHaltState* pHaltState)
    {
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchAsyncBreak: start: this=%p, pHaltState=%p\n", this, pHaltState);
        ...
        TryFinally([&]()
        {
            ...
            OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchAsyncBreak: initialized location: pHaltState=%p, pHaltState->IsValid()=%d\n",
                pHaltState, pHaltState->IsValid());
            ...
            if (pHaltState->IsValid())
            {
                ...
                {
                    OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchAsyncBreak: IsAtStoppingLocation: pHaltState=%p\n", pHaltState);
        ...
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchAsyncBreak: end: pHaltState=%p\n", pHaltState);
    }

    void ProbeContainer::DispatchInlineBreakpoint(InterpreterHaltState* pHaltState)
    {
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchInlineBreakpoint: start: this=%p, pHaltState=%p\n", this, pHaltState);
        ...
        {
            InitializeLocation(pHaltState);
            OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchInlineBreakpoint: initialized location: pHaltState=%p, pHaltState->IsValid()=%d\n",
                pHaltState, pHaltState->IsValid());
        ...
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchInlineBreakpoint: end: pHaltState=%p\n", pHaltState);
    }

    bool ProbeContainer::DispatchExceptionBreakpoint(InterpreterHaltState* pHaltState)
    {
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchExceptionBreakpoint: start: this=%p, pHaltState=%p\n", this, pHaltState);
        bool fSuccess = false;
        if (!haltCallbackProbe || haltCallbackProbe->IsInClosedState() || debugManager->IsAtDispatchHalt())
        {
            OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchExceptionBreakpoint: not in break mode: pHaltState=%p\n", pHaltState);
        ...
        TryFinally([&]()
        {
            ...
            OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchExceptionBreakpoint: initialized location: pHaltState=%p, IsInterpreterFrame=%d\n",
            ...
            if (pHaltState->IsValid() && pHaltState->GetFunction()->GetScriptContext()->IsScriptContextInDebugMode())
            {
                ...
                {
                    OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchExceptionBreakpoint: top function's context is different from the current context: pHaltState=%p, haltCallbackProbe=%p\n",
        ...
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchExceptionBreakpoint: end: pHaltState=%p, fSuccess=%d\n", pHaltState, fSuccess);
        return fSuccess;
    }
    ...
    void ProbeContainer::DispatchDOMMutationBreakpoint()
    {
        ...
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchDOMMutationBreakpoint: start: this=%p, pHaltState=%p\n", this, haltState);
        ...
        TryFinally([&]()
        {
            ...
            OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchDOMMutationBreakpoint: initialized location: pHaltState=%p, pHaltState->IsValid()=%d\n",
    ...
    void ProbeContainer::DispatchMutationBreakpoint(InterpreterHaltState* pHaltState)
    {
        ...
        OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchMutationBreakpoint: start: this=%p, pHaltState=%p\n", this, pHaltState);
        if (!CanDispatchHalt(pHaltState))
        {
            return;
        }
        ...
        {
            InitializeLocation(pHaltState);
            OUTPUT_TRACE(Js::DebuggerPhase, u"ProbeContainer::DispatchMutationBreakpoint: initialized location: pHaltState=%p, pHaltState->IsValid()=%d\n",
                pHaltState, pHaltState->IsValid());
    ...
    bool ProbeContainer::HasAllowedForException(JavascriptExceptionObject* exceptionObject)
    {
