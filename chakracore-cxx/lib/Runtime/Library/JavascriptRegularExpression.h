...
namespace Js
{
    ...
    private:
        ...
        friend class Js::CrossSiteObject<JavascriptRegExp>;
        void MarshalToScriptContext(Js::ScriptContext *scriptContext) override
        {
            Assert(this->GetScriptContext() != scriptContext);
            AssertMsg(VirtualTableInfo<JavascriptRegExp>::HasVirtualTable(this),
                      "Derived class need to define marshal to script context");
            VirtualTableInfo<Js::CrossSiteObject<JavascriptRegExp>>::SetVirtualTable(this);
        };
    protected:
