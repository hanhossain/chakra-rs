...
namespace Js
{
    ...
    JS_DIAG_INLINE StringCopyInfo::StringCopyInfo(
        ...
        _Inout_count_(sourceString->m_charLength) char16_t *const destinationBuffer)
    ...
    JS_DIAG_INLINE char16_t *StringCopyInfo::DestinationBuffer() const
    {
        Assert(isInitialized);
