...
namespace Js
{
   ...
   extern "C" Var amd64_CallFunction(RecyclableObject *function, JavascriptMethod entryPoint, CallInfo callInfo, uint argc, Var *argv);
    ...
    protected:
        ...
        friend class Js::CrossSiteObject<JavascriptFunction>;
        void MarshalToScriptContext(Js::ScriptContext *scriptContext) override
        {
            Assert(this->GetScriptContext() != scriptContext);
            AssertMsg(VirtualTableInfo<JavascriptFunction>::HasVirtualTable(this),
                      "Derived class need to define marshal to script context");
            VirtualTableInfo<Js::CrossSiteObject<JavascriptFunction>>::SetVirtualTable(this);
        };
    ...
    public:
        ...
        JavascriptString* DisplayNameHelper(const char16_t* name, charcount_t length) const;
