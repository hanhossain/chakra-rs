...
namespace Js
{
    ...
    public:
        ...
        private:
            ...
            const char16_t *GetAppendStringBuffer(JavascriptString *const s) const;
            ScriptContext *GetScriptContext() const;
            JavascriptLibrary *GetLibrary() const;

        private:
            char16_t *LastBlockChars();
        ...
        public:
            ...
            void AppendChars(const char16_t c);
