...
namespace Js
{
    ...
    class RegexHelper
    {
        ...
        static bool GetFlags(ScriptContext* scriptContext, __in_ecount(strLen) const char16_t* str, CharCount strLen, UnifiedRegex::RegexFlags &flags);
    public:
        static UnifiedRegex::RegexPattern* CompileDynamic(ScriptContext *scriptContext, const char16_t* psz, CharCount csz, const char16_t* pszOpts, CharCount cszOpts, bool isLiteralSource);
        static UnifiedRegex::RegexPattern* CompileDynamic(ScriptContext *scriptContext, const char16_t* psz, CharCount csz, UnifiedRegex::RegexFlags flags, bool isLiteralSource);
    private:
        static UnifiedRegex::RegexPattern* PrimCompileDynamic(ScriptContext *scriptContext, const char16_t* psz, CharCount csz, const char16_t* pszOpts, CharCount cszOpts, bool isLiteralSource);
    ...
    public:
        static UnifiedRegex::GroupInfo SimpleMatch(ScriptContext * scriptContext, UnifiedRegex::RegexPattern * pattern, const char16_t * inputStr,  CharCount inputLength, CharCount offset);
    ...
    public:
        ...
        template<bool mustMatchEntireInput> static BOOL RegexTest_NonScript(ScriptContext* scriptContext, JavascriptRegExp* regularExpression, const char16_t *const input, const CharCount inputLength);

    private:
        static void PrimBeginMatch(RegexMatchState& state, ScriptContext* scriptContext, UnifiedRegex::RegexPattern* pattern, const char16_t* input, CharCount inputLength, bool alwaysNeedAlloc);
    ...
    private:
        ...
        static int GetReplaceSubstitutions(const char16_t * const replaceStr, CharCount const replaceLength, ArenaAllocator * const tempAllocator, CharCount** const substitutionOffsetsOut);
