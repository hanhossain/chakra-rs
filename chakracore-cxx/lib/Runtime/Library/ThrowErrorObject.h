...
namespace Js
{
    ...
    public:
        ...
        static RecyclableObject* CreateThrowTypeErrorObject(ScriptContext* scriptContext, int32_t hCode, const char16_t * varName);
        static RecyclableObject* CreateThrowTypeErrorObject(ScriptContext* scriptContext, int32_t hCode, JavascriptString* varName);

    private:
        typedef JavascriptError* (JavascriptLibrary::*CreateErrorFunc)();
        static RecyclableObject* CreateThrowErrorObject(CreateErrorFunc createError, ScriptContext* scriptContext, int32_t hCode, const char16_t * varName);
    };
