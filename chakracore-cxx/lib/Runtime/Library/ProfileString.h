...
namespace Js
{
    ...
    private:
        ...
        static RequiredEncoding GetRequiredEncoding( const char16_t* sz, uint length );
        static uint CountEmbeddedNULs( const char16_t* sz, uint length );
        ...
        void RecordNewString( const char16_t* sz, uint length );
    ...
    public:
        ...
        static void RecordNewString( ScriptContext* scriptContext, const char16_t* sz, uint length );
