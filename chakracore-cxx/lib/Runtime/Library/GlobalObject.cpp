...
LHexError:
    ...
    BOOL GlobalObject::StrictEquals(Js::Var other, __out BOOL* value, ScriptContext * requestContext)
    {
        if (this == other)
        {
            *value = TRUE;
    ...
    BOOL GlobalObject::Equals(Js::Var other, __out BOOL* value, ScriptContext * requestContext)
    {
        if (this == other)
        {
            *value = TRUE;
