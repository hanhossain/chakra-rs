...
using namespace Js;
        ...
        uint functionId, Js::Utf8SourceInfo *utf8SrcInfo, Js::Var source)
    {
        ...
        Js::Var filenameString = Js::JavascriptString::NewCopyBuffer(file, std::u16string(file).length(), scriptContext);
        Js::Var funcnameString = Js::JavascriptString::NewCopyBuffer(function, std::u16string(function).length(), scriptContext);
