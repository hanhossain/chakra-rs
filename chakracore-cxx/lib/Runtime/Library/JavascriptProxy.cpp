...
namespace Js
{
    ...
    BOOL JavascriptProxy::Equals(Var other, __out BOOL* value, ScriptContext* requestContext)
    {
    ...
    BOOL JavascriptProxy::StrictEquals(Var other, __out BOOL* value, ScriptContext* requestContext)
    {
        *value = FALSE;
        //RecyclableObject* targetObj;
        if (IsRevoked())
