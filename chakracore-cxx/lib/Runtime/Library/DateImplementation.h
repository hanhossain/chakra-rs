...
namespace Js {
    ...
    private:
        ...
        // ISO format.
        static bool TryParseIsoString(const char16_t *const str, const size_t length, double &timeValue, ScriptContext *scriptContext);
        ...
        static bool FDateDelimiter(char16_t ch);
