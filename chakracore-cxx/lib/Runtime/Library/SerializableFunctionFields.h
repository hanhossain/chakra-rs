...
#define DECLARE_SERIALIZABLE_FIELD(type, name, serializableType) typename WriteBarrierFieldTypeTraits<type>::Type name
#endif
...
PROTECTED_FIELDS
    ...
    DECLARE_SERIALIZABLE_FIELD(uint32_t, m_grfscr, ULong);                     // For values, see fscr* values in scrutil.h.
