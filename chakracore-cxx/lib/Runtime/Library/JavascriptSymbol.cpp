...
namespace Js
{
    ...
    Var JavascriptSymbol::TryInvokeRemotelyOrThrow(JavascriptMethod entryPoint, ScriptContext * scriptContext, Arguments & args, int32_t errorCode, const char16_t * varName)
    {
