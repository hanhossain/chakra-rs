...
namespace Js
{
    ...
    namespace SSE2
    {
        ...
        public:
            ...
            static Var MulAddLeft(Var mulLeft, Var mulRight, Var addLeft, ScriptContext *scriptContext,
                                  JavascriptNumber *result);
            static Var MulAddRight(Var mulLeft, Var mulRight, Var addRight, ScriptContext *scriptContext,
                                   JavascriptNumber *result);
            static Var MulSubLeft(Var mulLeft, Var mulRight, Var subLeft, ScriptContext *scriptContext,
                                  JavascriptNumber *result);
            static Var MulSubRight(Var mulLeft, Var mulRight, Var subRight, ScriptContext *scriptContext,
                                   JavascriptNumber *result);
            ...
            static Var Exponentiation_InPlace(Var aLeft, Var aRight, ScriptContext *scriptContext,
                                              JavascriptNumber *result);
            ...
            static Var FinishOddDivByPow2_InPlace(int32_t value, ScriptContext *scriptContext,
                                                  JavascriptNumber *result);
            ...
            // different CRT versions define these with different calling conventions, so use our own method to prevent
        ...
        private:
            static Var Add_FullHelper(Var aLeft, Var aRight, ScriptContext *scriptContext, JavascriptNumber *result,
                                      bool leftIsDead);
            static Var Add_FullHelper_Wrapper(Var aLeft, Var aRight, ScriptContext *scriptContext,
            ...
            static Var Add_DoubleHelper(double dblLeft, Var addRight, ScriptContext *scriptContext,
                                        JavascriptNumber *result);
            static Var Add_DoubleHelper(Var addLeft, double dblRight, ScriptContext *scriptContext,
                                        JavascriptNumber *result);
            static Var Subtract_DoubleHelper(double dblLeft, Var subRight, ScriptContext *scriptContext,
                                             JavascriptNumber *result);
            static Var Subtract_DoubleHelper(Var subLeft, double dblRight, ScriptContext *scriptContext,
                                             JavascriptNumber *result);
