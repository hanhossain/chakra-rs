...
namespace Js
{
    ...
    inline Var JavascriptMath::Negate(Var aRight, ScriptContext *scriptContext)
    {
        ...
        return (TaggedInt::Is(aRight) && aRight != TaggedInt::ToVarUnchecked(0) && aRight != TaggedInt::MinVal())
    ...
    inline Var JavascriptMath::Not(Var aRight, ScriptContext *scriptContext)
    {
        ...
        return TaggedInt::Is(aRight) ? TaggedInt::Not(aRight, scriptContext) : Not_Full(aRight, scriptContext);
    }
    ...
    inline Var JavascriptMath::Or(Var aLeft, Var aRight, ScriptContext *scriptContext)
    {
        ...
        return TaggedInt::IsPair(aLeft, aRight) ? TaggedInt::Or(aLeft, aRight) : Or_Full(aLeft, aRight, scriptContext);
    }

    inline Var JavascriptMath::And(Var aLeft, Var aRight, ScriptContext *scriptContext)
    {
        JIT_HELPER_REENTRANT_HEADER(Op_And);
        return TaggedInt::IsPair(aLeft, aRight) ? TaggedInt::And(aLeft, aRight)
    ...
    inline Var JavascriptMath::ShiftLeft(Var aLeft, Var aRight, ScriptContext *scriptContext)
    {
        ...
        return TaggedInt::IsPair(aLeft, aRight) ? TaggedInt::ShiftLeft(aLeft, aRight, scriptContext)
    ...
    inline Var JavascriptMath::ShiftRight(Var aLeft, Var aRight, ScriptContext *scriptContext)
    {
        ...
        return TaggedInt::IsPair(aLeft, aRight) ? TaggedInt::ShiftRight(aLeft, aRight)
    ...
    inline Var JavascriptMath::ShiftRightU(Var aLeft, Var aRight, ScriptContext *scriptContext)
    {
        ...
        return TaggedInt::IsPair(aLeft, aRight) ? TaggedInt::ShiftRightU(aLeft, aRight, scriptContext)
    ...
    inline Var JavascriptMath::Xor(Var aLeft, Var aRight, ScriptContext *scriptContext)
    {
        ...
        return TaggedInt::IsPair(aLeft, aRight) ? TaggedInt::Xor(aLeft, aRight)
    ...
    inline Var JavascriptMath::Add(Var aLeft, Var aRight, ScriptContext *scriptContext)
    {
        ...
        return TaggedInt::IsPair(aLeft, aRight) ? TaggedInt::Add(aLeft, aRight, scriptContext)
    ...
    inline Var JavascriptMath::Subtract(Var aLeft, Var aRight, ScriptContext *scriptContext)
    {
        ...
        return TaggedInt::IsPair(aLeft, aRight) ? TaggedInt::Subtract(aLeft, aRight, scriptContext)
    ...
    inline double JavascriptMath::Multiply_Helper(Var aLeft, Var aRight, ScriptContext *scriptContext)
    {
        ...
        // The IEEE 754 floating point spec ensures that NaNs are preserved in all operations
        return JavascriptConversion::ToNumber(aLeft, scriptContext) *
...
#pragma prefast(suppress : 6031, "We don't care about the fraction part")
    ...
    {
        return JavascriptNumber::IsNan(v) || JavascriptNumber::IsZero(v) || JavascriptNumber::IsPosInf(v) ||
            JavascriptNumber::IsNegInf(v);
    }

    inline long JavascriptMath::TryToInt64(double T1) { return Js::NumberUtilities::TryToInt64(T1); }
    ...
    inline int32_t JavascriptMath::ToInt32(Var aValue, ScriptContext *scriptContext)
    {
        ...
        return TaggedInt::Is(aValue) ? TaggedInt::ToInt32(aValue) : ToInt32_Full(aValue, scriptContext);
    }
}; // namespace Js
