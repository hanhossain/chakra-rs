...
#error Unsupported processor type
    ...
    int TaggedInt::UnsignedToString(unsigned long value, char16_t *buffer, int bufferSize)
    {
    ...
    int TaggedInt::SignedToString(long value, char16_t *buffer, int bufferSize)
    {
        bool neg = value < 0;
