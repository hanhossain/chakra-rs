...
namespace Js
{
    ...
    public:
        ...
        static void CachePropertyReadForGetter(PropertyValueInfo *info, Var originalInstance, JsUtil::CharacterBuffer<char16_t> const& propertyName, ScriptContext* requestContext);
...
#if DBG_DUMP
        static void TraceCache(InlineCache * inlineCache, const char16_t * methodName, PropertyId propertyId, ScriptContext * requestContext, RecyclableObject * object);
        static void TraceCache(PolymorphicInlineCache * polymorphicInlineCache, const char16_t * methodName, PropertyId propertyId, ScriptContext * requestContext, RecyclableObject * object);
#endif
...
#if DBG_DUMP
        static void TraceCacheCommon(const char16_t * methodName, PropertyId propertyId, ScriptContext * requestContext, RecyclableObject * object);
#endif
    };
}
