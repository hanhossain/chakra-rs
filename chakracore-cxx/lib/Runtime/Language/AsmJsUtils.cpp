            ...
            else if (info->GetArgType(i).isInt64())
            {
                ...
                if (i < actualArgCount)
                {
                    ...
                    else if (DynamicObject::IsBaseDynamicObject(*origArgs))
                    {
                        ...
                        scriptContext->GetOrAddPropertyRecord(u"low", (int)PAL_wcslen(u"low"), &lowPropRecord);
                        scriptContext->GetOrAddPropertyRecord(u"high", (int)PAL_wcslen(u"high"), &highPropRecord);
