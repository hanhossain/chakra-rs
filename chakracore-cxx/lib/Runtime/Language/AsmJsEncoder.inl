...
#define PROCESS_ENCODE_READ_LAYOUT_ASMJS(name, layout, suffix) \
    ...
    const OpLayout##layout##suffix * playout = mReader.layout##suffix(ip);
...
{
    template <class T>
    void AsmJsEncoder::OP_Empty( const T* playout )
    {

    }

    template <class T>
    void AsmJsEncoder::OP_CheckHeap(const T* playout)
    {
        // Todo
    }

    void AsmJsEncoder::OP_Label( const OpLayoutEmpty* playout )
    {
    ...
    template <class T>
    void AsmJsEncoder::OP_Br( const T* playout )
    {
    ...
    template <class T>
    void AsmJsEncoder::OP_BrTrue( const T* playout )
    {
        if( playout->RelativeJumpOffset )
        {
            const int labelOffset = mReader.GetCurrentOffset() + playout->RelativeJumpOffset;
    ...
    template <class T>
    void AsmJsEncoder::OP_BrEq( const T* playout )
    {
        if( playout->RelativeJumpOffset )
        {
            const int labelOffset = mReader.GetCurrentOffset() + playout->RelativeJumpOffset;
    ...
    template <class T>
    void AsmJsEncoder::OP_BrEqConst(const T* playout)
    {
        if (playout->RelativeJumpOffset)
        {
            const int labelOffset = mReader.GetCurrentOffset() + playout->RelativeJumpOffset;
    ...
    template <class T> void Js::AsmJsEncoder::OP_StartCall( const T* playout )
    {
        AsmJsJitTemplate::StartCall::ApplyTemplate( this, mPc, playout->ArgCount);
    }

    template <class T> void Js::AsmJsEncoder::OP_Call( const T* playout )
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::Op_LdArrConst( const T* playout )
    {
        if (playout->ViewType == ArrayBufferView::TYPE_FLOAT32)
        {
    ...
    template <class T>
    void Js::AsmJsEncoder::Op_StArr( const T* playout )
    {
        if (playout->ViewType == ArrayBufferView::TYPE_FLOAT32 )
        {
            //Value can be double
    ...
    template <class T>
    void Js::AsmJsEncoder::Op_StArrConst( const T* playout )
    {
        if (playout->ViewType == ArrayBufferView::TYPE_FLOAT32 )
        {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_LdF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_LdI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_LdD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_IntsToI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_DoublesToD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_SplatI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_SplatD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromFloat64x2F4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromInt32x4F4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromFloat32x4I4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromFloat64x2I4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromFloat32x4D2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromInt32x4D2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromFloat64x2BitsF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromInt32x4BitsF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromFloat32x4BitsI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromFloat64x2BitsI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromFloat32x4BitsD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_FromInt32x4BitsD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_AbsF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_AbsD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_NegF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_NegI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_NegD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_RcpF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_RcpD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_RcpSqrtF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_RcpSqrtD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_SqrtF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_SqrtD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_NotF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_NotI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_AddF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_AddI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_AddD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_SubF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_SubI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_SubD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_MulF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_MulI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_MulD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_DivF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_DivD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_MinF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_MinD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_MaxF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_MaxD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_LtF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_LtI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_LtD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_GtF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_GtI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_GtD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_LtEqF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_LtEqD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_GtEqF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_GtEqD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_EqF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_EqI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_EqD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_NeqF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_NeqD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_AndF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_AndI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_OrF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_OrI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_XorF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_XorI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_SelectF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_SelectI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_SelectD2(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_ExtractLaneI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_ExtractLaneF4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_ReplaceLaneI4(const T* playout)
    {
    ...
    template <class T>
    void Js::AsmJsEncoder::OP_Simd128_ReplaceLaneF4(const T* playout)
    {
