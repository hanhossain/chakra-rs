...
namespace Js {
    ...
    public:
        ...
        static int ToBuffer(int value, __out_ecount_z(bufSize) char16_t * buffer, uint bufSize);
        static int ToBuffer(uint value, __out_ecount_z(bufSize) char16_t * buffer, uint bufSize);
        ...
        static int SignedToString(__int64 value, char16_t *buffer, int bufferSize);
        static int UnsignedToString(unsigned __int64 value, char16_t *buffer, int bufferSize);
