...
EXDEF2    (BRPROP,                  BrOnNoProperty,             OP_BrOnNoProperty)
  DEF2    (BRLOCALPROP,             BrOnHasLocalProperty,       OP_BrOnHasProperty)
EXDEF2    (BRENVPROP,               BrOnHasEnvProperty,         OP_BrOnHasEnvProperty)
  DEF2    (BRENVPROP,               BrOnHasLocalEnvProperty,    OP_BrOnHasEnvProperty)
...
EXDEF2_WMS(A1toA1Mem,               Typeof_ReuseLoc,            JavascriptOperators::Typeof)
...
EXDEF2_WMS(XXtoA1,                  LdLocalObj_ReuseLoc,        OP_LdLocalObj)
  DEF2_WMS(XXtoA1,                  LdLocalObj,                 OP_LdLocalObj)
EXDEF2_WMS(XXtoA1,                  LdParamObj,                 OP_LdParamObj)
EXDEF2_WMS(FALLTHROUGH,             UnwrapWithObj_ReuseLoc,     /* Common case with UnwrapWithObj */)
...
EXDEF2_WMS(ELEM_RtU_to_XX,          EnsureCanDeclGloFunc,       OP_EnsureCanDeclGloFunc)
  ...
  DEF2_WMS(FALLTHROUGH,             LdFld_ReuseLoc,             /* Common case with LdFld */)
  DEF3_WMS(CUSTOM_L_Value,          LdFld,                      OP_GetProperty, ElementCP)
  DEF2_WMS(FALLTHROUGH,             LdLocalFld_ReuseLoc,        /* Common case with LdLocalFld */)
...
EXDEF3_WMS(CUSTOM_L_Value,          LdRootFldForTypeOf,         OP_GetRootPropertyForTypeOf, ElementRootCP)
  ...
  DEF2_WMS(FALLTHROUGH,             ProfiledLdFld_ReuseLoc,     /* Common case with ProfiledLdFld */)
  DEF3_WMS(CUSTOM_L_Value,          ProfiledLdFld,              PROFILEDOP(OP_ProfiledGetProperty, OP_GetProperty), ElementCP)
  DEF2_WMS(FALLTHROUGH,             ProfiledLdLocalFld_ReuseLoc,/* Common case with ProfiledLdLocalFld */)
...
EXDEF3_WMS(CUSTOM_L_Value,          DeleteFld_ReuseLoc,         OP_DeleteFld, ElementC)
EXDEF2_WMS(FALLTHROUGH,             DeleteLocalFld_ReuseLoc,    /* Common case with DeleteLocalFld */)
...
EXDEF2_WMS(FALLTHROUGH,             LdEnvObj_ReuseLoc,          /* LdEnvObj */)
EXDEF3_WMS(GET_ELEM_ENVSLOTNonVar,  LdEnvObj,                   OP_LdEnvObj, ElementSlotI1)
...
EXDEF2_WMS(EnvU1toXX,               InvalCachedScope,           JavascriptOperators::OP_InvalidateCachedScope)
...
EXDEF2_WMS(XXtoA2_FB,               InitBaseClass,              OP_InitBaseClass)
