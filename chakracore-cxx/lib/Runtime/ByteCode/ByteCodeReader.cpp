...
#include "LayoutTypesAsmJs.h"
    ...
    template AuxArray<int32_t> const * ByteCodeReader::ReadAuxArray<int32_t>(uint offset, FunctionBody * functionBody);
    ...
    template AuxArray<int32_t> const * ByteCodeReader::ReadAuxArrayWithLock<int32_t>(uint offset, FunctionBody * functionBody);
