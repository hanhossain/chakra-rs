...
namespace Js
{
    ...
    protected:
        ...
        public:
            ...
            inline void WriteUnsafe(__in_bcount(byteSize) const void* data, uint byteSize)
            {
        ...
        private:
            ...
            void Write(__in_bcount(byteSize) const void* data, uint byteSize);
            void SlowWrite(__in_bcount(byteSize) const void* data, uint byteSize);
    ...
    public:
        ...
        void ElementUnsigned1(OpCode op, RegSlot value, RegSlot instance, uint32_t element);
        ...
        void Slot(OpCode op, RegSlot value, RegSlot instance, uint32_t slotId);
        void Slot(OpCode op, RegSlot value, RegSlot instance, uint32_t slotId, ProfileId profileId);
        void SlotI1(OpCode op, RegSlot value, uint32_t slotId1);
        void SlotI1(OpCode op, RegSlot value, uint32_t slotId1, ProfileId profileId);
        void SlotI2(OpCode op, RegSlot value, uint32_t slotId1, uint32_t slotId2);
        void SlotI2(OpCode op, RegSlot value, uint32_t slotId1, uint32_t slotId2, ProfileId profileId);
        ...
        void ElementPIndexed(OpCode op, RegSlot value, uint cacheId, uint32_t scopeIndex);
        ...
        template <typename SizePolicy> bool TryWriteCallIWithICIndex(OpCode op, RegSlot returnValueRegister, RegSlot functionRegister, ArgSlot givenArgCount, uint32_t inlineCacheIndex, bool isRootLoad);
        template <typename SizePolicy> bool TryWriteCallIFlagsWithICIndex(OpCode op, RegSlot returnValueRegister, RegSlot functionRegister, ArgSlot givenArgCount, uint32_t inlineCacheIndex, bool isRootLoad, CallFlags callFlags);
        template <typename SizePolicy> bool TryWriteCallIExtended(OpCode op, RegSlot returnValueRegister, RegSlot functionRegister, ArgSlot givenArgCount, CallIExtendedOptions options, uint32_t spreadArgsOffset);
        template <typename SizePolicy> bool TryWriteCallIExtendedWithICIndex(OpCode op, RegSlot returnValueRegister, RegSlot functionRegister, ArgSlot givenArgCount, InlineCacheIndex inlineCacheIndex, bool isRootLoad, CallIExtendedOptions options, uint32_t spreadArgsOffset);
        template <typename SizePolicy> bool TryWriteCallIExtendedFlags(OpCode op, RegSlot returnValueRegister, RegSlot functionRegister, ArgSlot givenArgCount, CallIExtendedOptions options, uint32_t spreadArgsOffset, CallFlags callFlags);
        template <typename SizePolicy> bool TryWriteCallIExtendedFlagsWithICIndex(OpCode op, RegSlot returnValueRegister, RegSlot functionRegister, ArgSlot givenArgCount, InlineCacheIndex inlineCacheIndex, bool isRootLoad, CallIExtendedOptions options, uint32_t spreadArgsOffset, CallFlags callFlags);
        template <typename SizePolicy> bool TryWriteElementI(OpCode op, RegSlot Value, RegSlot Instance, RegSlot Element);
        template <typename SizePolicy> bool TryWriteElementUnsigned1(OpCode op, RegSlot Value, RegSlot Instance, uint32_t Element);
        ...
        template <typename SizePolicy> bool TryWriteElementSlot(OpCode op, RegSlot value, RegSlot instance, uint32_t slotId);
        template <typename SizePolicy> bool TryWriteElementSlotI1(OpCode op, RegSlot value, uint32_t slotId);
        template <typename SizePolicy> bool TryWriteElementSlotI2(OpCode op, RegSlot value, uint32_t slotId1, uint32_t slotId2);
        template <typename SizePolicy> bool TryWriteElementSlotI3(OpCode op, RegSlot value, RegSlot instance, uint32_t slotId, RegSlot homeObj);
        ...
        template <typename SizePolicy> bool TryWriteElementPIndexed(OpCode op, RegSlot value, uint32_t scopeIndex, CacheId cacheId);
