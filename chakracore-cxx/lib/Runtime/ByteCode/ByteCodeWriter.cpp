...
namespace Js
{
...
#endif
    {
        ...
        if (currentAstSize == maxAstSize)
        {
            ...
            Output::Print(u"\tAST Bytecode ratio: %f\n", astBytecodeRatio);
        }
#endif
...
StoreCommon:
    ...
    void ByteCodeWriter::Data::Write(__in_bcount(byteSize) const void* data, uint byteSize)
    {
    ...
    void ByteCodeWriter::Data::SlowWrite(__in_bcount(byteSize) const void* data, uint byteSize)
    {
