...
namespace Js
{
    ...
    private:
        ...
        typename WriteBarrierFieldTypeTraits<SimplePropertyDescriptor>::Type descriptors[size];
    ...
    public:
        SimpleTypeHandler(const PropertyRecord *id, _no_write_barrier_tag, PropertyAttributes attributes = PropertyNone,
                          PropertyTypes propertyTypes = PropertyTypesNone, uint16 inlineSlotCapacity = 0,
                          uint16 offsetOfInlineSlots = 0);
        // Constructor of a shared typed handler
        SimpleTypeHandler(SimplePropertyDescriptor const (&SharedFunctionPropertyDescriptors)[size],
                          _no_write_barrier_tag, PropertyTypes propertyTypes = PropertyTypesNone,
                          uint16 inlineSlotCapacity = 0, uint16 offsetOfInlineSlots = 0);
        ...
        {
            return !ChangeTypeOnProto() && !(GetIsOrMayBecomeShared() && IsolatePrototypes());
        }
