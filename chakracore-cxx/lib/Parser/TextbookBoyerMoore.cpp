...
namespace UnifiedRegex
{
    ...
    static bool MatchPatternAt(uint inputChar, char16_t const * pat, CharCount index);

    template <>
    bool MatchPatternAt<1, 1>(uint inputChar, char16_t  const* pat, CharCount index)
    {
    ...
    template struct TextbookBoyerMooreSetup<char16_t>;
    template class TextbookBoyerMoore<char16_t>;
    template class TextbookBoyerMooreWithLinearMap<char16_t>;

    template
    bool TextbookBoyerMoore<char16_t>::Match<1>
        ( const Char *const input
        , const CharCount inputLength
        , CharCount& inputOffset
        , const Char* pat
    ...
    template
    bool TextbookBoyerMoore<char16_t>::Match<CaseInsensitive::EquivClassSize>
        ( const Char *const input
        , const CharCount inputLength
        , CharCount& inputOffset
        , const Char* pat
    ...
    template
    bool TextbookBoyerMoore<char16_t>::Match<CaseInsensitive::EquivClassSize, 1>
        ( const Char *const input
        , const CharCount inputLength
        , CharCount& inputOffset
        , const Char* pat
    ...
    template
    bool TextbookBoyerMooreWithLinearMap<char16_t>::Match<1>
        ( const Char *const input
        , const CharCount inputLength
        , CharCount& inputOffset
        , const Char* pat
