...
namespace UnifiedRegex
{
    ...
    class CharTrie : private Chars<char16_t>
    {
    ...
    struct CharTrieEntry : private Chars<char16_t>
    {
        Char c;
        CharTrie node;
    };
    ...
    class RuntimeCharTrie : private Chars<char16_t>
    {
        int count;
    ...
    struct RuntimeCharTrieEntry : private Chars<char16_t>
    {
        Char c;
