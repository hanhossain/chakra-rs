...
#define JSCRIPT_E_CANTEXECUTE            ((int32_t)0x89020001L)
#define DISP_E_UNKNOWNINTERFACE          ((int32_t)0x80020001L)
#define DISP_E_MEMBERNOTFOUND            ((int32_t)0x80020003L)
#define DISP_E_UNKNOWNNAME               ((int32_t)0x80020006L)
#define DISP_E_NONAMEDARGS               ((int32_t)0x80020007L)
#define DISP_E_EXCEPTION                 ((int32_t)0x80020009L)
#define DISP_E_BADINDEX                  ((int32_t)0x8002000BL)
#define DISP_E_UNKNOWNLCID               ((int32_t)0x8002000CL)
#define DISP_E_ARRAYISLOCKED             ((int32_t)0x8002000DL)
#define DISP_E_BADPARAMCOUNT             ((int32_t)0x8002000EL)
#define DISP_E_PARAMNOTOPTIONAL          ((int32_t)0x8002000FL)
#define DISP_E_NOTACOLLECTION            ((int32_t)0x80020011L)
#define TYPE_E_DLLFUNCTIONNOTFOUND       ((int32_t)0x8002802FL)
#define TYPE_E_TYPEMISMATCH              ((int32_t)0x80028CA0L)
#define TYPE_E_OUTOFBOUNDS               ((int32_t)0x80028CA1L)
#define TYPE_E_IOERROR                   ((int32_t)0x80028CA2L)
#define TYPE_E_CANTCREATETMPFILE         ((int32_t)0x80028CA3L)
#define TYPE_E_CANTLOADLIBRARY           ((int32_t)0x80029C4AL)
#define STG_E_TOOMANYOPENFILES           ((int32_t)0x80030004L)
#define STG_E_ACCESSDENIED               ((int32_t)0x80030005L)
#define STG_E_INSUFFICIENTMEMORY         ((int32_t)0x80030008L)
#define STG_E_NOMOREFILES                ((int32_t)0x80030012L)
#define STG_E_DISKISWRITEPROTECTED       ((int32_t)0x80030013L)
#define STG_E_READFAULT                  ((int32_t)0x8003001EL)
#define STG_E_SHAREVIOLATION             ((int32_t)0x80030020L)
#define STG_E_LOCKVIOLATION              ((int32_t)0x80030021L)
#define STG_E_MEDIUMFULL                 ((int32_t)0x80030070L)
#define STG_E_INVALIDNAME                ((int32_t)0x800300FCL)
#define STG_E_INUSE                      ((int32_t)0x80030100L)
#define STG_E_NOTCURRENT                 ((int32_t)0x80030101L)
#define STG_E_CANTSAVE                   ((int32_t)0x80030103L)
#define REGDB_E_CLASSNOTREG              ((int32_t)0x80040154L)
#define MK_E_UNAVAILABLE                 ((int32_t)0x800401E3L)
#define MK_E_INVALIDEXTENSION            ((int32_t)0x800401E6L)
#define MK_E_CANTOPENFILE                ((int32_t)0x800401EAL)
#define CO_E_APPNOTFOUND                 ((int32_t)0x800401F5L)
#define CO_E_APPDIDNTREG                 ((int32_t)0x800401FEL)
