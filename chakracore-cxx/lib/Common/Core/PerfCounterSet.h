    ...
    public:
        DefaultCounterSetInstance() : InstanceBase(TCounter::GetProvider(), TCounter::GetGuid())
        {
            ...
            else
            {
                ...
                data = InstanceBase::InitializeSharedMemory(TCounter::MaxCounter, handle);
                if (data == nullptr)
                {
                    data = defaultData;
                }
        ...
        ~DefaultCounterSetInstance()
        {
            ...
            if (data != defaultData)
            {
                InstanceBase::UninitializeSharedMemory(data, handle);
            }
        }
        ...
        bool Initialize()
        {
            ...
            {
                char16_t wszModuleName[_MAX_PATH];
                ...
                return InstanceBase::Initialize(wszFilename, getpid());
            }
            return false;
        }
    private:
