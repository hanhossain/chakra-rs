...
FLAGNRA(String, ExecutionModeLimits,        Eml,  "Execution mode limits in th form: AutoProfilingInterpreter0.ProfilingInterpreter0.AutoProfilingInterpreter1.SimpleJit.ProfilingInterpreter1 - Example: -ExecutionModeLimits:12.4.0.132.12", u"")
...
FLAGNR(String,  OutputFile            , "Log the output to a specified file. Default: output.log in the working directory.", u"output.log")
FLAGNR(String,  OutputFileOpenMode    , "File open mode for OutputFile. Default: wt, specify 'at' for append", u"wt")
#ifdef ENABLE_TRACE
...
FLAGNR(String, autoProxy, "enable creating proxy for each object creation", u"__msTestHandler")
