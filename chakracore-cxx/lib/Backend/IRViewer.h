...
public:
    ...
    /* utility functions */
    static Js::PropertyId CreateProperty(Js::ScriptContext *scriptContext, const char16_t *propertyName);
    static void SetProperty(Js::DynamicObject *obj, const char16_t *propertyName, Js::Var value);
    static void SetProperty(Js::DynamicObject *obj, Js::PropertyId id, Js::Var value);
    static void GetStatementSourceString(__out_ecount(len) char16_t *buffer, LPCUTF8 sourceBegin, LPCUTF8 sourceEnd, const size_t len);
