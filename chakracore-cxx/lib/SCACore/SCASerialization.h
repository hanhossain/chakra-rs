...
namespace Js
{
    ...
    class SerializationCloner : public ClonerBase<Var, scaposition_t, TypeId, SerializationCloner<Writer>>
    {
    public:
    ...
    private:
        void WriteTypeId(SCATypeId typeId) const { Write(static_cast<uint32_t>(typeId)); }

        void Write(uint32_t data) const { m_writer->Write(data); }
    ...
    public:
        SerializationCloner(ScriptContext *scriptContext, Writer *writer,
                            JsUtil::List<SharedContents *, HeapAllocator> *sharedContentsrList) :
            ClonerBase<Var, scaposition_t, TypeId, SerializationCloner<Writer>>(scriptContext), m_writer(writer),
            m_sharedContentsrList(sharedContentsrList)
        {
        }
        ...
        SrcTypeId GetTypeId(Src src) const { return JavascriptOperators::GetTypeId(src); }
    ...
    public:
        ObjectPropertyEnumerator(ScriptContext *scriptContext, RecyclableObject *obj,
                                 JavascriptStaticEnumerator *enumerator) :
            ScriptContextHolder(scriptContext), m_obj(obj), m_innerEnumerator(enumerator), m_name(NULL), m_value(NULL)
        {
        }

        bool MoveNext();

        const char16_t *GetNameString() const { return m_name->GetString(); }

        charcount_t GetNameLength() const { return m_name->GetLength(); }
    ...
    //
    template <class T, bool clamped = false, bool isVirtual = false>
    ...
    template <>
    struct TypedArrayTrace<int8_t> : TypedArrayTraceBase<int8_t>
    {
        static SCATypeId GetSCATypeId() { return SCA_Int8Array; }
    };
    template <>
    struct TypedArrayTrace<uint8_t, false> : TypedArrayTraceBase<uint8_t, false>
    {
        static SCATypeId GetSCATypeId() { return SCA_Uint8Array; }
    };
    template <>
    struct TypedArrayTrace<uint8_t, true> : TypedArrayTraceBase<uint8_t, true>
    {
        static SCATypeId GetSCATypeId() { return SCA_Uint8ClampedArray; }
    };
    template <>
    struct TypedArrayTrace<int16> : TypedArrayTraceBase<int16>
    {
        static SCATypeId GetSCATypeId() { return SCA_Int16Array; }
    };
    template <>
    struct TypedArrayTrace<uint16> : TypedArrayTraceBase<uint16>
    {
        static SCATypeId GetSCATypeId() { return SCA_Uint16Array; }
    };
    template <>
    struct TypedArrayTrace<int32_t> : TypedArrayTraceBase<int32_t>
    {
        static SCATypeId GetSCATypeId() { return SCA_Int32Array; }
    };
    template <>
    struct TypedArrayTrace<uint32_t> : TypedArrayTraceBase<uint32_t>
    {
        static SCATypeId GetSCATypeId() { return SCA_Uint32Array; }
    };
    template <>
    struct TypedArrayTrace<float> : TypedArrayTraceBase<float>
    {
        static SCATypeId GetSCATypeId() { return SCA_Float32Array; }
    };
    template <>
    struct TypedArrayTrace<double> : TypedArrayTraceBase<double>
    {
        static SCATypeId GetSCATypeId() { return SCA_Float64Array; }
    };
    template <>
    struct TypedArrayTrace<int8_t, false, true> : TypedArrayTraceBase<int8_t, false, true>
    {
        static SCATypeId GetSCATypeId() { return SCA_Int8Array; }
    };
    template <>
    struct TypedArrayTrace<uint8_t, false, true> : TypedArrayTraceBase<uint8_t, false, true>
    {
        static SCATypeId GetSCATypeId() { return SCA_Uint8Array; }
    };
    template <>
    struct TypedArrayTrace<uint8_t, true, true> : TypedArrayTraceBase<uint8_t, true, true>
    {
        static SCATypeId GetSCATypeId() { return SCA_Uint8ClampedArray; }
    };
    template <>
    struct TypedArrayTrace<int16, false, true> : TypedArrayTraceBase<int16, false, true>
    {
        static SCATypeId GetSCATypeId() { return SCA_Int16Array; }
    };
    template <>
    struct TypedArrayTrace<uint16, false, true> : TypedArrayTraceBase<uint16, false, true>
    {
        static SCATypeId GetSCATypeId() { return SCA_Uint16Array; }
    };
    template <>
    struct TypedArrayTrace<int32_t, false, true> : TypedArrayTraceBase<int32_t, false, true>
    {
        static SCATypeId GetSCATypeId() { return SCA_Int32Array; }
    };
    template <>
    struct TypedArrayTrace<uint32_t, false, true> : TypedArrayTraceBase<uint32_t, false, true>
    {
        static SCATypeId GetSCATypeId() { return SCA_Uint32Array; }
    };
    template <>
    struct TypedArrayTrace<float, false, true> : TypedArrayTraceBase<float, false, true>
    {
        static SCATypeId GetSCATypeId() { return SCA_Float32Array; }
    };
    template <>
    struct TypedArrayTrace<double, false, true> : TypedArrayTraceBase<double, false, true>
    {
        static SCATypeId GetSCATypeId() { return SCA_Float64Array; }
    };
    template <>
    struct TypedArrayTrace<DataView>
    {
